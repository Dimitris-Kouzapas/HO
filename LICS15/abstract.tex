...
This work proposes efficient bisimulations 
...
nor recursions.    
We then develop three typed bisimulations 
and prove their coincidence with a corresponding contextual equivalence. 
One of the three bisimulations demonstrates observing 
only specific values which inhabit session types is sufficient 
enough to reason about the \HOp-calculus. 
...
that the first-order session $\pi$-calculus can encode 
...
The results highlight the expressiveness of the \HO-calculus 
