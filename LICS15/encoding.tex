...
\noi We now move on present our encodability results, which rely on precise encodings; 
our non encodability result is presented in \S\,\ref{sec:negative}, using minimal encodings.
