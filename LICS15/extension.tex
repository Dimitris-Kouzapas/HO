...
\label{subsec:pho}
The encoding of the polyadic name passing 
into monadic name passing is well-known in the literature.    
In addition, using the linear typing, 
we can also obtain the preciseness \cite{Yoshida96}.
We can easily show $\HOp$
