...
\]
%
\dk{The type system disallows polyadic shared names.}
...
%		\\ % action mapping starts here
		...
		&\!\!\!\!\defeq\!\!\!\!&
		\news{\tilde{m_1}'}\bactout{n}{m_1} \cdots \news{\tilde{m_k}'}\bactout{n}{n_k} \\
		&& m_1 \in \tilde{m} \Leftrightarrow \tilde{m_1}' = m_1 \wedge
		\\
		&& m_1 \notin \tilde{m} \Leftrightarrow \tilde{m_1}' = \es 
		\\
%		\mapa{\bactinp{k}{k_1, \ldots, k_m}}^4 &\defeq&   \big\{\bactinp{k}{k_1}, \cdots, \bactinp{k}{k_m} \big\}\\
		\mapa{\news{\tilde{m}} \bactout{n}{\abs{x_1, \ldots, x_m}{P}} }^4 
		&\!\!\!\!\defeq\!\!\!\!&
		\bactout{n}{\abs{z}\binp{z}{x_1} \cdots \binp{z}{x_m} \map{P}^{4}}\\[1mm]
