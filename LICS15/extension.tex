...
are also precise. 
\end{theorem}
\NY{We can mechanically extend the preciseness to 
a super-calculus of $\HOpp$ and $\PHOp$ (denoted by  $\PHOpp$ in Fig.~\ref{fig:express}) 
by summing up Thms.~\ref{f:enc:phopiptohopi} and 
\ref{f:enc:phopiptohopi}.}
