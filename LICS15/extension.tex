...
%
<<<<<<< HEAD
\NY{The type system disallows %types of the form $\chtype{\chtype{U}}$ i.e.\,
shared channels that carry polyadic values as in \cite{tlca07,MostrousY15}.}
=======
{The type system disallows a shared name directly carries polyadic
  shared names as in \cite{tlca07,MostrousY15},
  i.e. $\chtype{\tilde{\chtype{S}}}$ is disallowed.}
>>>>>>> a760211e0b14ecbdb097a8b3c776263b55e823f0
