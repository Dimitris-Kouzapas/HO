...
(we replace $C$ by $U$ in \trule{Abs} and $C$ by $U'$ in \trule{App} in Fig.~\ref{fig:typerulesmy}).
\smallskip 
...
Fig.~\ref{fig:typerulesmy} with extended \trule{Abs} and \trule{App}. 
...
due to the fact that the shared name encoding
is not precise.}
