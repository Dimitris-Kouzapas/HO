...
%		\\
		...
		\\ 
		\map{\appl{x}{(u_1, \cdots, u_k)}}^{4}
		&\!\!\!\!\defeq\!\!\!\!&
		\newsp{s}{\appl{x}{s} \Par \bout{\dual{s}}{u_1} \cdots. \bout{\dual{s}}{u_k} \inact}
		\\
		\map{\appl{(\abs{x_1,\dots,x_n}{P})}{(u_1, \cdots, u_k)}}^{4}
		&\!\!\!\!\defeq\!\!\!\!&\\
		\multicolumn{3}{l}{
		\qquad \qquad \qquad \qquad \newsp{s}{\binp{s}{x_1} \dots \binp{s}{x_n} \pmap{P}{4} \Par \bout{\dual{s}}{u_1} \cdots. \bout{\dual{s}}{u_k} \inact} 
		}
        \\ 
	\end{array}
\]
