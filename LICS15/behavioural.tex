...
\dk{We sometimes annotate the output action with
the type of value $V$ as in $\news{\tilde{m}} \bactout{n}{V: U}$.}
...
$\Gamma; \es; \Delta \proves s,\dual{s} \hastype \tinact$,
...
in the higher-order setting, but if the calculus is limited  
%the $\sessp$-calculus, 
into~\jpc{\sessp}
