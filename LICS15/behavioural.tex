...
The example below extends the motivation in \S\,\ref{sec:intro}.
\smallskip  
...
%
where $\ell$ stands for the input label.
...
We now define characteristic processes:
...
=======
\begin{enumerate}[1.]
>>>>>>> 6ab75e41c1a4281bc9d6e98dc0d49356bd2a6fdc
