...
\begin{enumerate}[1.]
\item The first-order name-passing communication without recursions into 
the higher-order communication without name-passing and 
recursions (\S\,\ref{ss:ffotoho})
\item  The first-order name-passing calculus 
with recursions into the higher-order 
communication without name-passing and 
recursions (\S\,\ref{ss:fullfotoho})
\item the higher-order communication without 
name-passing and recursions  into the first-order communication
