...
is different than~\defref{def:ep}(3a), due to triggers. 
This way, e.g., 
if  
...
where 
$\ell_2 = (\nu \tilde{m})\bactout{n}{a}$ and
$Q = \pmap{P' \Par  \repl{} \binp{a}{y} \binp{y}{x} R}{2}$.
This is the same form of operational correspondence given by Sangiorgi in~\cite{SangiorgiD:expmpa},
and turns out to be useful in proving full abstraction.
