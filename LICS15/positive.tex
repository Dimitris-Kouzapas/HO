...
\begin{definition}[Trigger Mapping] \label{d:trabs}\label{d:auxmap}
	...
	\figref{f:auxmap} defines a trigger mapping
...
\]
%  
\dk{$\fn{P}$ denotes a sequence of lexicopraphically ordered 
free names in $P$.}
...
\dk{Processes that are typed with the non-tail
recursive session type were studied in
\cite{DBLP:journals/corr/abs-1202-2086,DBLP:journals/corr/BernardiH13},
but this is the first time they are used in
a meaningfull application.}
