...
They will be formally encoded into \HO in \secref{subsec:pho}.
...
``duplicator'' process. Finally, we define the encoding of $z_X$ 
...
A detailed example of this encoding strategy is given in~\cite{KouzapasPY15}.
}
%The idea follows 
