...
``duplicator'' process~\cite{ThomsenB:plachoasgcfhop}. Finally, we define the encoding of $z_X$ 
...
A detailed example of this encoding is given in~\cite{KouzapasPY15}.
}
%The idea follows 
