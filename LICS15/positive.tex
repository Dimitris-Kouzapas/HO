...
\begin{array}{rcll}
		...
		\pmapp{\bsel{s}{l} P}{1}{f} &\defeq& \bsel{s}{l} \pmapp{P}{1}{f} \qquad
		\pmapp{\bbra{s}{l_i: P_i}_i \in I}{1}{f} \defeq \bbra{s}{l_i: \pmapp{P_i}{1}{f}}_i \in I\\
		\pmapp{\bout{k}{\abs{\tilde{x}}{Q}} P}{1}{f} &\defeq& \bout{k}{\abs{\tilde{x}}{\pmapp{Q}{1}{f}}} \pmapp{P}{1}{f} \qquad
		\pmapp{\binp{k}{X} P}{1}{f} \defeq \binp{k}{X} \pmapp{P}{1}{f}\\

		\pmapp{P \Par Q}{1}{f} &\defeq& \pmapp{P}{1}{f} \Par \pmapp{Q}{1}{f} \qquad
		\pmapp{\news{n} P}{1}{f} \defeq \news{n} \pmapp{P}{1}{f} \qquad
		...
		\mapa{\bactout{n}{\abs{\tilde{x}}{P}}}^{1} &\defeq& \bactout{n}{\abs{\tilde{x}}{\pmapp{P}{1}{\es}}} \qquad
		\mapa{\bactinp{n}{\abs{\tilde{x}}{P}}}^{1} \defeq \bactinp{n}{\abs{\tilde{x}}{\pmapp{P}{1}{\es}}}\\
		\mapa{\tau} &\defeq& \tau
	\end{array}
\]
