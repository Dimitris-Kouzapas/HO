...
As mentioned earlier, \HOp and \HO feature \emph{first-order} abstractions; this means that
only (shared/linear) names can be used as arguments to abstractions $\abs{x}P$.
We consider \HOpp, an extension of \HOp with \emph{higher-order} abstractions; this 
means that in \HOpp also processes can be arguments of abstractions.
The encoding is a natural extension of the encoding of \HOp into \HO;
