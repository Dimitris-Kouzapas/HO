...
\dk{Encoding a recursive process $\recp{X}{P}$ is challenging, for 
the linearity of endpoints in $P$ must be preserved.
We encode recursion with non-tail recursive session types; for this 
we apply advances on the theory of session duality~\cite{BernardiH14,TGC14,DBLP:journals/corr/abs-1202-2086}.}
...
\item \S\,\ref{s:expr} defines \emph{typed encodings} by extending encodability criteria 
proposed for
