...
see \S\,\ref{subsec:hop} for a definition.
...
In \pHOp polyadicity appears in intrasession communications and abstractions; 
polyadicity of session names is not defined. Encoding \pHOp into \HOp is straightforward
in a session-typed setting, as detailed in \S\,\ref{subsec:pho}.
For instance, we may define:
\[
\begin{array}{rl}
		\map{\binp{u}{u_1, \cdots, u_m} P}
		 =  & \!\!\!\!
		\binp{u}{u_1} \cdots ;  \binp{u}{u_m} \map{P}
		\\
