...
from typed and untyped perspectives \cite{} (JORGE PLS ADD FROM WHAT WE CITED).
...
offer new equalities and fully abstract encodability, (to our best knowledge) not proposed before.   
...
into the $\pi$-calculus preserving session types extending 
know untyped results is an important result, 
