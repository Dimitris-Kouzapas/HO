...
for \HOp.
A well-studied behavioral equivalence in the higher-order setting is \emph{contextual equivalence},
...
are shown to coincide with contextual equivalence.
...
Here again the name usage information given by session types is fundamental to define the encodings
and to state semantic correspondences.
That is, our encodings concern source and target processes
endowed with proper communication structures which are described by session types. 
...
giving details of the technical novelties. 
