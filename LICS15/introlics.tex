...
have yet to be developed. To this end, here we study
...
communication structures found in practical protocols,  expressible via recursive session types.
...
Thus, the calculus $\sessp$ is assimilable to the calculus in~\cite{honda.vasconcelos.kubo:language-primitives}, widely studied in the literature;
