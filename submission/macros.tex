...
\newcommand{\orule}[1]{{\footnotesize{\brtext{#1}}}}
...
\newcommand{\tmap}[2]{\ensuremath{\langle\!\!\langle#1\rangle\!\!\rangle^#2}}
\newcommand{\namemap}[2]{#1\map{#2}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\fHOp}{Full $\mathsf{HO}\pi$ }
\newcommand{\sesp}{session-$\pi$ }
\newcommand{\HO}{\mathsf{HO}\pi}
