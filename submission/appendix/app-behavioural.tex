...
%
	\begin{eqnarray}
		\Gamma; \emptyset; \Sigma_1 \cat s: S_1 \by{\bactinp{s}{\abs{x} P}} \Sigma_1 \cat s: S_2 \proves P_1 \by{\bactinp{s}{\abs{x} P}} P_2 \subst{(x) P}{X} \label{lem:wbc_is_wb14}
	\end{eqnarray}
%
	\noi with $S_1 = \btinp{\lhot{S}} S_2 \vee S_1 = \btinp{\shot{S}} S_2$ implies that
