...
%					and
%					\[
%						\Gamma; \emptyset; \Sigma_1 \cat s: S_2\ \mathcal{R}_{n-1}\ \Sigma_2'' \proves P_2  \subst{\abs{x}{\map{S}^x}}{X}\ \mathcal{R}_{n-1}\ 
...
%
	...
	\end{eqnarray}
%
%	\noi with $S_1 = \btinp{\lhot{S}} S_2 \vee S_1 = \btinp{\shot{S}} S_2$
	implies
...
%
	...
	\end{eqnarray}
%
%	\noi \dk{with $s_1: S \in \Sigma_1 \vee (\dual{s_1}: S' \in \Sigma_1' \wedge S \dualof S')$}
...
%
	...
	\end{eqnarray*}
%	with $\Gamma; \es; \Sigma_1 \hby{\bactinp{s}{(x)\map{S}^x}} \Gamma; \es; \Sigma_1'$.% s_1: S \in \Sigma_1 \vee (\dual{s_1}: S' \in \Sigma_1' \wedge S \dualof S')$}
%
