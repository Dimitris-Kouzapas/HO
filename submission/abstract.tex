% !TEX root = main.tex
\begin{abstract}
This work studies the expressiveness of a family of the first-order and
higher-order $\pi$-calculi, fully exploring 
features of session communication. 
We identify a small, core higher-order calculus with session 
...
The results highlight how the shared name passing 
separates the expressivity of higher-order session calculi
and makes it more difficult to reason about process equivalences. 
