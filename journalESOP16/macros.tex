...
\newcommand{\ltsrule}[1]{{\footnotesize \ensuremath{\lrangle{\textrm{#1}}}}}
...
%\newcommand{\map}[1]{[\!\![#1]\!\!]}
\newcommand{\map}[1]{\ensuremath{\llbracket#1\rrbracket}}

\newcommand{\umap}[1]{\ensuremath{\llbracket#1\rrbracket^u}}
\newcommand{\pmap}[2]{\ensuremath{\llbracket#1\rrbracket^\mathtt{#2}}}
\newcommand{\pmapp}[3]{\ensuremath{\llbracket#1\rrbracket^\mathtt{#2}_#3}}
\newcommand{\auxmap}[2]{\ensuremath{\{\!|#1|\!\}^\mathtt{#2}}}
\newcommand{\tauxmap}[2]{\ensuremath{\{\!|#1|\!\}^\mathtt{#2}}}
\newcommand{\auxmapp}[3]{\ensuremath{\big\lfloor\!\!\big\lfloor#1\big\rfloor\!\!\big\rfloor^\mathtt{#2}_#3}}
\newcommand{\tmap}[2]{\ensuremath{(\!\!\langle#1\rangle\!\!)^\mathtt{#2}}}
\newcommand{\vtmap}[2]{{\ensuremath{\big\lfloor #1\big\rfloor^\mathtt{#2}}}}
\newcommand{\mapt}[1]{\ensuremath{(\!\!\langle#1\rangle\!\!)}}
\newcommand{\mapa}[2]{\ensuremath{\{\!\!\{#1\}\!\!\}^{\mathtt{#2}}}}
\newcommand{\namemap}[2]{#1\map{#2}}
...
\newcommand{\ghot}[1]{#1\! \leadsto\! \diamond}
...
%\dmfalse
\newcommand{\dk}[1]
{\ifdm{\color{blue}{DK: #1}}\else{#1}\fi}
