...
We now present the proof of the full abstraction theorem (\propref{prop:fulla_HOp_to_HO}).
...
\bigskip
	...
	\noi Given $\horel{\Gamma}{\Delta_1}{P_1}{\hby{\news{\tilde{m_1}'} \bactout{n}{m_1}}}{\Delta_1'}{P_2}$, \propref{app:prop:op_corr_HOp_to_HO} implies that:
%
	\[
...
%
	...
	\]
	\noi Based on the encoding \pmapp{\cdot}{1}{f}, we may rewrite the last result as follows:
	\[
...
%
	...
	\end{eqnarray}
%
	\noi From~\ref{prop:HOp_to_HO:full_abs1} and \propref{app:prop:op_corr_HOp_to_HO} we obtain:
%
	\[
...
%
	...
	\noi -Subcase: The proof of \propref{app:prop:op_corr_HOp_to_HO} implies that
%
	\[
...
%
	...
	\end{eqnarray}
%
	\noi From~\eqref{prop:HOp_to_HO:full_abs3} and \propref{app:prop:op_corr_HOp_to_HO}, we obtain:
%
	\[
		\horel{\mapt{\Gamma}^{1}}{\mapt{\Delta_2}^{1}}{\pmapp{Q_1}{1}{f}}{\Hby{\news{\tilde{m_2}'} \bactout{n}{\abs{z}{\binp{z}{x} (\appl{x}{m_2})}}}}{\mapt{\Delta_2'}^{1}}{\pmapp{Q_2}{1}{f}}
	\]
...
%
	...
	\end{eqnarray}
%
	\noi From~\eqref{prop:HOp_to_HO:full_abs5} and \propref{app:prop:op_corr_HOp_to_HO} we obtain:
%
	\[
...
\bigskip
	\noi \textbf{Part 2.} The proof for Part 2 is straightforward following \defref{d:enc:hopitopi}.
...
\bigskip
	...
	\noi {\bf Part 1: Soundness}. Consider the relation:
	\[
...
%
	...
	the bisimulation game that is implied by the labelled operational correspondence (\propref{app:prop:op_corr_HOp_to_p}).
...
%
	...
	\end{eqnarray*}
%
	From  \propref{app:prop:op_corr_HOp_to_p} (Part 1), we have that:
%
	\begin{eqnarray*}
...
%
	...
	\noi Now, from~\eqref{prop:fa_ho_sessp_1} and  \propref{app:prop:op_corr_HOp_to_p} (Part 1), we infer that:
...
%
	...
	\noi
	Also, from $\mathcal{R}$ we infer that both:
	%
	\begin{eqnarray*}
