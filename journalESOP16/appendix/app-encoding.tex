...
%
	...
	\mhorel	{\mapt{\Gamma}}
		{\mapt{\Delta_1'}}
		{\newsp{a_1}{\pmap{P'}{2} \Par \repl \bout{a_1}{y} \binp{y}{x} \pmap{R_1}{2} \Par \binp{t}{x} \newsp{s}{ \binp{s}{y} \mapchar{U}{y} \Par \bout{s}{a_1} \inact }}}
		{\fwb}
		{\mapt{\Delta_2'}}
		{}
		{\newsp{a_2}{\pmap{Q'}{2} \Par \repl \bout{a_2}{y} \binp{y}{x} \pmap{R_2}{2} \Par \binp{t}{x} \newsp{s}{ \binp{s}{y} \mapchar{U}{y} \Par \bout{s}{a_1} \inact } }}
...
%
	...
	\end{eqnarray*}
%
	If we follow the bisimulation transitions, that are determinate transitions, on the last bisimulation pair we get that (\dk{attention here})
	...
	\noi Consider relation
	\[
		\mathcal{R} = \set{ \horel{\mapt{\Gamma}^{2}}{\mapt{\Delta_1}^2}{\pmap{P}{2}}{\fwb}{\mapt{\Delta_2}^2}{\pmap{Q}{2}} \setbar  \horel{\Gamma}{\Delta_1}{P}{,}{\Delta_2}{Q}}
	\]
%
	The interesting case is the output case. The rest of the cases follow
	the bisimulation game that is implied by the labelled correspondence Proposition~\ref{app:prop:op_corr_HOp_to_p}.
