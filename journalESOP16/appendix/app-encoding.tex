...
%
	...
	\noi There are two subcases following \propref{app:prop:op_corr_HOp_to_HO}:
...
%
	...
	\item Case: $\ell = \bactinp{n}{\abs{x}{P}}$. Then we have two subcases following \propref{app:prop:op_corr_HOp_to_HO}:
