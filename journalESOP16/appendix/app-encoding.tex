...
\bigskip
	...
	\noi {\bf Part 2. Completeness}. \jpc{This was wrong, please check} We show that the relation
	\[
...
%		{\pmap{Q'}{2} \Par \repl \binp{a_2}{y} \binp{y}{x} \pmap{R_2}{2}}
	\begin{eqnarray*}
		\tmap{\Gamma}{2}; \emptyset; \tmap{\Delta_2}{2} \proves \pmap{Q}{2}
...
In the following proposition, recall that we use the mapping on actions $\mapa{\cdot}^{3}$ given in \defref{d:actmap3}.
...
\begin{enumerate}
	...
	\begin{enumerate}[a)]
			...
			\item	\jpc{This was different, please check} Case 1(a): 
...
and therefore
		...
		\item	\jpc{This was different, please check} Case 1(c): Then 
...
%
	\[
		\Re_1 = \set{(\horel{\Gamma}{\Delta_1}{P}{\ ,\ }{\Delta_2}{Q}) \setbar \horel{\tmap{\Gamma}{3}}{\tmap{\Delta_1}{3}}{\pmap{P}{3}}{\hwb}{\tmap{\Delta_2}{3}}{\pmap{Q}{3}}}
	\]
%
...
%
	\[
		\Re_2 = \set{(\horel{\tmap{\Gamma}{3}}{\tmap{\Delta_1}{3}}{\pmap{P}{3}}{\ ,\ }{\tmap{\Delta_2}{3}}{\pmap{Q}{3}}) \setbar \horel{\Gamma}{\Delta_1}{P}{\hwb}{\Delta_2}{Q}}
	\]
...
In the following proposition, recall that we use the mapping on actions $\mapa{\cdot}^{4}$ given in \defref{d:actmap4}.
...
$$
which, using  \figref{f:enc:poltomon}s, can be expressed as: 
$$
...
\noi	The left-to-right direction follows by showing that relation: %create the closure
%
	\[
