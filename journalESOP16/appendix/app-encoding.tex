...
%
	...
	\mhorel	{\Gamma}
		...
		{Q' \Par \binp{t}{x} \newsp{s}{ \binp{s}{y} \mapchar{U}{y} \Par \bout{s}{R_2} \inact } }
$$
	\noi as required. \jpc{I didn't understand this step: rather than $R_1$, $R_2$ above you obtain some $R_3, R_4$ such that $R_3 =  \pmap{R_1}{2}$ and $R_4 =  \pmap{R_2}{2}$, right?}
...
%
	...
	\noi as required \jpc{Why is the above pair sufficient to complete the proof - don't you need to get rid of the replicated server?}
