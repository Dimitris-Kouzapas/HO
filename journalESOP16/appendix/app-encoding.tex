...
We consider three representative cases:
	...
	%%%% Output of (linear) channel
		\item	Case $P = \bbout{k}{\abs{x}{Q}}P$. Then we have two possibilities, depending on the typing for $\abs{x}Q$.
			The first case concerns a linear typing, and so  
...
By IH we have:
						...
						\tree{
							\tree{
								\tree{
									...
									\tmap{\Gamma}{2}; \es ; \tmap{\Delta_2}{2}\cat y:\tinact \cat a:\tinact \cat x:\tmap{S_1}{2}
									\proves 
									\pmap{Q}{2} \hastype \Proc
								}
							}{
								\tmap{\Gamma}{2}; \es ; \tmap{\Delta_2}{2}\cat y: \btinp{\tmap{S_1}{2}}\tinact \cat a:\tinact 
								\proves 
								\binp{y}{x}\pmap{Q}{2} \hastype \Proc
							} 
						}{
							\tmap{\Gamma}{2}; \es ; \tmap{\Delta_2}{2} \cat a:\btinp{\btinp{\tmap{S_1}{2}}\tinact}\tinact
							\proves 
							\binp{a}{y}\binp{y}{x}\pmap{Q}{2} \hastype \Proc
						} 
			\end{eqnarray}
			Let $U_1 = \btinp{\btinp{\tmap{S_1}{2}}\tinact}\tinact$ stand for the type of $a$.
			We then have:
			\begin{eqnarray}
				...
				\tree{
					...
					\cat a:U_1
							& \proves &
							\binp{a}{y}\binp{y}{x}\pmap{Q}{2} \hastype \Proc
						\qquad \eqref{prop:HO_to_sessp_t00}
					\end{array}
				}{
				%\begin{array}{r}
					\tmap{\Gamma}{2}; \es ; 
			...
			FIX ABOVE: $a$ 	SHOULD BE A SHARED NAME
			===
