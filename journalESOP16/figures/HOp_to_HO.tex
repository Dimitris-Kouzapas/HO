...
%\\[1mm]
%
Above $\fn{P}$ is a lexicographically ordered sequence  of free names in $P$.
The input bound variable $x$ is type-annotated to distinguish first- and higher-order cases.
Mapping
