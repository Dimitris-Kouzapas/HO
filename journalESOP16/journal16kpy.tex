...
We recall the case study for \HOp that we developed in our previous work~\cite{characteristic_bis,KouzapasPY17}, an abstraction of a \emph{hotel booking scenario}.
