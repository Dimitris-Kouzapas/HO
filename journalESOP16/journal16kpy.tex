...
We sometimes write $\repl{} P$ to denote a replicated process $P$, which is representable as $\recp{X}{(P \Par \rvar{X})}$. 
...
\begin{definition}[Auxiliary Mappings] \label{d:trabs}\label{d:auxmap}
