...
We consider mappings for terms and types (denoted $\map{\cdot}^{3}$ and $\mapt{\cdot}^{3}$, respectively), but also for (higher-order) values (denoted ($\auxmap{\cdot}{3}$). We illustrate the essence of these mappings by means of an example.
