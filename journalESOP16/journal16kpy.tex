...
This paper is an extended, revised version of the homonymous conference paper that appeared in the Proceedings of ESOP'16~\cite{DBLP:conf/esop/KouzapasPY16}.
...
\noindent We close this section  by stating  type soundness for \HOp, as established in~\cite{KouzapasPY17}; it implies 
...
(strong) transitions. % in this LTS. 
...
two dual endpoints), while 
 ...
 We write  $\horel{\Gamma}{\Delta}{P}{\hby{\dtau}}{\Delta'}{P'}$ to denote
	...
	See~\cite{KouzapasPY17} for definitions of $\hby{\btau}$  and $\hby{\stau}$. % rely on an LTS for \HOp;  for details.
 \end{notation}
...
\begin{proof}
By induction on theinference of $\Gamma; \emptyset; \Delta \proves P \hastype \Proc$.
