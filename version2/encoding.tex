...
\begin{proof}
	Let $\Gamma_1; \Lambda_1; \Sigma_1 \proves P_1 \cong \Gamma_2; \Lambda_2; \Sigma_2 \proves P_2 \hastype \Proc$
	...
	From the fact that
	$\Gamma_1; \Lambda_1; \Sigma_1 \proves P_1 \cong \Gamma_2; \Lambda_2; \Sigma_2 \proves P_2 \hastype \Proc$
	we can derive that
	\[
		\Gamma_1'; \Lambda_1'; \Sigma_1' \proves P_1 \Par \bacc{a}{x} P_2 \cong \Gamma_2'; \Lambda_2'; \Sigma_2' \proves P_2 \Par \bacc{a}{x} P_1 \hastype \Proc
	\]
