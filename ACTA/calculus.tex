...
%%%%%%%%%%%%%%%%%%%%%% End HOp Syntax Figure %%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\[
		\begin{array}{rcl}
			\multicolumn{3}{c}{n \bnfis a,b  \bnfbar s, \dual{s} \qquad \quad
...
Later on, we will show that $\Client_1$ and $\Client_2$ are behaviourally equivalent using characteristic bisimilarity;
