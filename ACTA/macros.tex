...
%\newcommand{\ltsrule}[1]{{\footnotesize \ensuremath{\lrangle{\textsc{#1}}}}}
\newcommand{\ltsrule}[1]{{\ensuremath{\lrangle{\text{\footnotesize \textsc{#1}}}}}}
%\newcommand{\eltsrule}[1]{{\footnotesize \ensuremath{[\textsc{#1}]}}}
\newcommand{\eltsrule}[1]{{\ensuremath{[\text{\footnotesize \textsc{#1}}]}}}
...
\newcommand{\entails}{\textrm{implies}}
...
\newcommand{\mact}[1]{\breve{#1}}

\newcommand{\sesstran}{session-transition\xspace}
\newcommand{\betatran}{$\beta$-transition\xspace}
\newcommand{\stau}{\tau_{\mathsf{s}}}
\newcommand{\btau}{\tau_{\beta}}
\newcommand{\dtau}{\tau_{\mathsf{d}}}
...
%%%%% triggers
%\newcommand{\hotrigger}[4]{\binp{#1}{#2} \newsp{#3}{\appl{#2}{#3} \Par \bout{\dual{#3}}{#4} \inact}}
\newcommand{\hotrigger}[4]{\binp{#1}{#2} \newsp{#3}{\binp{#3}{y} (\appl{#2}{y}) \Par \bout{\dual{#3}}{#4} \inact}}
%\newcommand{\hotrigger}[2]{\binp{#1}{x} \newsp{s}{\appl{x}{s} \Par \bout{\dual{s}}{#2} \inact}}
%\newcommand{\fotrigger}[5]{\binp{#1}{#2} \newsp{#3}{\mapchar{#4}{#3} \Par \bout{\dual{#3}}{#5} \inact}}
\newcommand{\fotrigger}[5]{\binp{#1}{#2} \newsp{#3}{\binp{#3}{y}  \mapchar{#4}{y} \Par \bout{\dual{#3}}{#5} \inact}}
%\newcommand{\fotrigger}[2]{\binp{#1}{X} \appl{X}{#2}}

\newcommand{\auxtr}[1]{\abs{\widetilde{z}}{\binp{#1}{y} (\appl{y}{\widetilde{z}})}}
\newcommand{\jauxtr}[2]{\abs{\widetilde{#1}}{\binp{#2}{y} (\appl{y}{\widetilde{#2}})}}

\newcommand{\trval}[2]{\abs{#2}{\binp{#1}{y} (\appl{y}{#2})}}
\newcommand{\trvalx}[1]{\trval{#1}{x}}

\newcommand{\ntrigger}[2]{#1 \leftharpoonup_\mathtt{A} #2}
...
\newcommand{\ahorel}[6]{
	\begin{array}{r@{\hskip -0.01mm}c@{\hskip -0.01mm}l}
...
\newcommand{\newc}[1]{#1}
%\newcommand{\JP}[1]{\textcolor{magenta}{\textbf{JP asks: #1}}}
\newcommand{\JP}[1]{}
\newcommand{\jasks}[1]{\textcolor{magenta}{#1}}
...
\dkfalse
\newcommand{\dk}[1]
{\ifdk{\color{red}{#1}}\else{#1}\fi}

\newcommand{\dkmargin}[1]
{
	\ifdk
		{\color{green}{$\bullet$} \marginpar{\color{green}{$\bullet$}#1}}
	\fi
}
...
\newcommand{\mydefref}[1]{Definition~\ref{#1} (Page~\pageref{#1})}
...
\newcommand{\mylemref}[1]{Lemma~\ref{#1} (Page~\pageref{#1})}
...
\newcommand{\htrigger}[2]{#1 \hookleftarrow_{\mathtt{H}} #2}

%\newcommand{\ftrigger}[3]{#1 \Leftarrow \AT{#2}{#3}}
\newcommand{\ftrigger}[3]{#1 \Leftarrow_{\mathtt{C}} #2{\,:\,}#3}
