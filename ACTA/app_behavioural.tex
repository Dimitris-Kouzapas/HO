...
%\end{definition}
In the following we sometimes use the polyadic abstractions 
(denoted $\abs{\tilde{x}}{P}$)
and polyadic name passing 
(denoted $\bout{u}{\tilde{V}}{P}$   $\binp{u}{\tilde{x}}{P}$)
...
\begin{proof}
\JP{I am pretty sure that this holds, but why do we have a proof by induction? Strictly speaking, we need a co-inductive proof in which we show that the relation 
$$
\Re = \{ (P,P') ~|~ \horel{\Gamma}{\Delta}{P}{\hby{\dtau}}{\Delta'}{P'}\}
$$
is a higher-order bisimulation. Such a coinductive proof would use the current analysis.
}
	\noi 
	...
	\begin{enumerate}[a)]
		\item	First direction. Consider the typed relation (we omit the type information):
				...
				\[
					...
					{\Delta_1'}{\newsp{\widetilde{m_1}'}{P' \Par \newsp{s}{\bout{t}{s} \inact}  } }
				\]
				which implies from the freshness of $t$ that there exist $\ell_2, Q'$ with
				$\ell_2 = \ell_1$ in the case $\ell_1$ not being an output, such that
				\begin{eqnarray}
					\horel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \newsp{s}{\bout{t}{s} \inact}  } }
					{\Hby{\ell_2}}
					{\Delta_2'}{\newsp{\widetilde{m_2}'}{Q' \Par \newsp{s}{\bout{t}{s} \inact}  } }
				...
				\begin{enumerate}[i)]
					...
					\[
							...
							\[
								...
								{\Delta_4}{\news{\widetilde{m_2}}{Q'  } }
							\]
					\item	The interaction of name $t$ with process $P$: this is not possible
	...
	\begin{enumerate}
		\item First direction. Let $\Re$ be the typed relation (we omit the type information):
				...
				\begin{enumerate}[i)]
					...
					\item	An input action, $\bactinp{t}{n}$ along fresh name $t$.
							In this we have that there exists $U$ such that $\omapchar{U} = n$:
							\[
								\horel{\Gamma}{\Delta_3}{\newsp{\widetilde{m_1}}{P \Par \htrigger{t}{V_1}  } }
								{\hby{\bactinp{t}{n}}}
...
%							\JP{Why $Q$ doesn't move to some $Q'$ in the above weak transition?} and
							...
							\\
							From the fact that $\omapchar{U} = n$ we have that
							$\omapchar{\btinp{U} \tinact} = \abs{z}{ \binp{z}{y} ( \bout{t'}{z} \inact \Par (\appl{y}{n}) ) } $:
							\[
								\mhorel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \ntrigger{t}{V_1}  } }
...
%							\JP{Why $Q$ doesn't move to some $Q'$ in the above weak transition?} 
						...
						\item	An action, $\bactinp{t}{\abs{z}{\mapchar{U'}{z}}}$, along fresh name $t$.
								This means that there exists $U$ such that $\omapchar{U} = \abs{z}{\mapchar{U'}{z}}$: 
							\[
								\horel{\Gamma}{\Delta_3}{\newsp{\widetilde{m_1}}{P \Par \htrigger{t}{V_1}  } }
...
%							\JP{Also above $Q$ should move. I think the parenthesis for the abstraction are not OK.} and
							...
							From the fact that $\omapchar{U} = \abs{z}{\mapchar{U'}{z}}$ we get that
							$\omapchar{\btinp{U} \tinact} = \abs{w}{ \binp{w}{y} ( \bout{t'}{w} \inact \Par \appl{(\abs{z}{\mapchar{U'}{z}})}{y} ) }$
							and
							\[
								\mhorel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \ntrigger{t}{V_1}  } }
								{\hby{\bactinp{t}{\omapchar{\btinp{U} \tinact}}}}
...
%							\JP{Why $Q$ doesn't move to some $Q'$ in the above weak transition?}
		...
		\Re &=&	\set{	(\newsp{\widetilde{m_1}}{P \Par \ntrigger{t}{V_1}}\ ,\ 
				...
				\begin{enumerate}
					\item	Value $V_1$ is higher-order which implies that there exists $U$
							such that $\omapchar{\btinp{U} \tinact} = \abs{z}{ \binp{z}{y} (\bout{t'}{z} \inact \Par \appl{y}{n})}$:
							\[
								\mhorel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \ntrigger{t}{V_1}  } }
								{\hby{\bactinp{t}{\omapchar{\btinp{U} \tinact}}}}
								{\Delta_1'}{}{\newsp{\widetilde{m_1}'}{P \Par \newsp{s}{ \appl{(\abs{z}{ \binp{z}{y} (\bout{t'}{z} \inact \Par (\appl{y}{n}))})}{s} \Par \bout{\dual{s}}{V_1} \inact}}}
...
%							\JP{Why $Q$ doesn't move to some $Q'$ in the above weak transition?}
						...
						\item	Value $V_1$ is first-order which implies that there exists $U$
...
%							{\hby{\bactinp{t}{m}}}
						...
						\]
						%
							implies from the higher-order bisimilarity requirement of $\Re$ and
							the freshness of $t$ that $\exists Q', \Delta_2''$ such that
						%
							\begin{eqnarray}
								\begin{array}{crll}
...
%									{\hby{\bactinp{t}{m}}}& & &
						...
						%
							...
							in \eqref{proof:trig_equiv22} to get that for some $\Delta_4$
						%
							\begin{eqnarray*}
								\begin{array}{crll}
									& \Gamma; \es; \Delta_2' & \proves &		
...
%									{\hby{\bactinp{t}{\map{\btinp{U} \tinact}^{x}}}}& & &
		...
		\item	Consider the typed relation (for readability, we omit type information):
				...
				\end{eqnarray*}
				%
				By proving that $\Re \subseteq \fwb$ we can then apply \lemref{lem:alt_tr} (Part 3), to
				get that $\Re' \subseteq \fwb$.
				%
			...
			We distinguish three cases, depending on the source/kind of visible action: 
				\begin{enumerate}
					\item	Case
						...
						%
							then following the requirements of $\Re$ and the freshness of $t$
							we can conclude that there exists some $\Delta_1''$ such that
						%
						\[
							\horel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \ftrigger{t}{V_1}{U}}}
							{\hby{\ell_1}}
						...
						%
							implies from the characteristic bisimilarity requirement of $\Re$ and
							the freshness of $t$ that there exist $Q', \Delta_2''$ such that
						%
							\begin{eqnarray}
							\horel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \ftrigger{t}{V_2}{U}}}
							{\Hby{\ell_2}}
						...
						%
							...
							and $C_1 = C_2 = \inact$ otherwise.
						%
							From \eqref{proof:trig_equiv0} we can conclude that there exists $\Delta_4$ such that
						\[
						...
						\]
						%
							Equation \eqref{proof:trig_equiv1} then allows us to conclude that
						\[
					...
					\item	%\jasks{I would probably put cases 2 and 3 within a single case, which is the case when the right-hand side process moves. }
						...
						\end{eqnarray*}
						%
							which implies from the higher-order bisimulation requirement of $\Re$ and
							the freshness of $t$ that there exists $Q', \Delta_2''$ such that
						%
							\begin{eqnarray}
								\begin{array}{crll}
									& \Gamma; \es; \Delta_2 & \proves &		
						...
						%
							The freshness of $t$ allows us to mimic the transitions
							in \eqref{proof:trig_equiv2} to imply that for some $\Delta_4$
							we have
						%
							\begin{eqnarray*}
								\begin{array}{crll}
	...
	\begin{enumerate}
		...
		\item
			...
			\[
				...
				{\Delta_1'}{\newsp{\widetilde{m_1}'}{P' \Par \appl{(\trvalx{t})}{n_1} }}
			\]
			implies that there exist $\Delta_2'$, $\newsp{\widetilde{m_2}'}{Q' \Par \appl{(\trvalx{t})}{n_2} }$ and $\ell_2$ such that
			\[
...
We analyse each part separately:
	\begin{enumerate}[1.]
		\item	The proof for Part 1 is done by contradiction.
				...
				\[
					\horel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \appl{(\trvalx{t})}{n_1} }}
					{ \hby{\dtau} \hby{ \bactinp{t}{\omapchar{U}}  } \hby{\ell_1} }
					{\Delta_1'}{\newsp{\widetilde{m_1}}{P \Par \bout{t'}{n_1} \inact }}
				\]
%				\JP{Why do we skip the tau related to beta-reduction?}
				with $\subj{\ell_1} = n_1$, because of the characteristic process interaction,
%					\JP{Why? I think $\ell_1$ can come from $P$ and be different from $n_1$..}
				...
				\]
				with $\subj{\ell_2} = n_1$. %\JP{Here again, why?}
...
\begin{lemma}[Trigger Substitution]
	...
	Let $P$ and $Q$ be processes. Also, let $t_i, i \in I$ be a fresh name. If
	\[
		\horel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P \Par \prod_{i \in I} \appl{(\trvalx{t_i})}{n_i} }}
		{\hwb}
		{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par\prod_{i \in I} \appl{(\trvalx{t_i})}{m_i} }}
	\]
	then for all $\abs{\widetilde{x}}{R}$ there exist $\exists \Delta_1', \Delta_2'$ such that
	\[
...
\begin{proof}
	We prove the result up-to the deterministic application
	...
	\begin{enumerate}
		...
		\[
				...
				\end{eqnarray}
				where $C_1, C_2$ are the higher-order trigger processes if $\ell_1, \ell_2$ are output actions
				and $C_1 = C_2 = \inact$ otherwise.
		...
		\[
				...
				\begin{enumerate}[i.]
					...
					\item	$\subj{\ell} = n_k$ and $n_k = m_k$.
							...
							\]
							that implies from the definition of $\Re$ that for all $R$ such that $\widetilde{x} \in \fn{R}$
							\[
								\horel{\Gamma}{\Delta_3'}{\newsp{\widetilde{m_1}'}{P \Par R \subst{\widetilde{n}}{\widetilde{x}} }}
								{\ \Re\ }
								{\Delta_4'}{\newsp{\widetilde{m_2}'}{Q'' \Par R \subst{\widetilde{m}}{\widetilde{x}}}}
...
%							The proof is a consequence of Part 3 \lemref{lem:trigger_application}.
							...
							\[
								...
								\Par  \mapchar{U}{x} \subst{m_k}{x} }}
							\]
							From Part 2 of \lemref{lem:trigger_application} we get that if 
							\[
								\mhorel{\Gamma}{\Delta_3}{  \newsp{\widetilde{m_1}'}{P \Par \prod_{i \in I\backslash{k}} \binp{t_i}{x} (\appl{x}{n_i})
								\Par  \mapchar{U}{x} \subst{n_k}{x} }}
								{ \hby{\tau} }
							...
							This means that there exists a $U'$ (cf. \defref{def:char})
							\begin{eqnarray*}
								\newsp{\widetilde{m_1}'}{P \Par \prod_{i \in I\backslash{k}} \binp{t_i}{x} (\appl{x}{n_i})}
...
\begin{proof}
	...
	substitution $\subst{{\abs{x}{R}}}{z}$ has an effect on the action denoted by $\ell_1$:
	\begin{enumerate}
...
%				of an application on name $x$.
				...
				\begin{itemize}
					...
					\item	Sub-case (Assume $Q = P \Par \prod_{i \in I} \appl{z}{n_i}$)
							...
							\end{eqnarray*}
							%
							From \lemref{lem:trigger_subst} we can deduce that $\forall \abs{x}{R}$, if there exist $\Delta_5, \Delta_6$ then
							\begin{eqnarray*}
...
\begin{proof}
	...
	The proof proceeds by a case analyses on the action label $\ell$.
...
%						\horel{\Gamma}{\Delta_1}{P_1}{\hby{\bactinp{n}{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}}}{\Delta_1'}{P_2 \subst{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}{x}}\\
					...
					\end{array}
				\]
			In turn, the above transition and $\Re$ imply the existence of a process $Q_2$ such that:
			%
			\[
...
%					\horel{\Gamma}{\Delta_1'}{P_2 \subst{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}{x}}{\hwb}{\Delta_2'}{Q_2 \subst{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}{x}}\\
			...
			\]
			for all $P$ with $\fv{P} = \widetilde{x}$, as required. %\newc{JP - I have modified, please check.}

		\item	Case $\ell = \news{\widetilde{m_1}'} \bactout{n}{\widetilde{m_1}}$: In this case, 
 transition \eqref{lem:wb_is_wbc1} and $\Re$ imply the existence of a process $Q_2$ and name $m_2$ such that 
			%
			\[
			...
			\[
				...
				\end{array}
			\]
			where, in each case, the $\tau$-steps correspond to deterministic internal transitions (in the sense of \defref{def:dettrans}). Therefore, it is easy to see that 
			%
			\[
				\horel{\Gamma}{\Delta_1''}{\newsp{\widetilde{m_1}'}{P_2 \Par  R \subst{m_1}{x}}}{\hwb}{\Delta_2}{\newsp{\widetilde{m_2}'}{Q_2 \Par R \subst{m_2}{x}} }
			\]
			for all $R$ with $\fpv{R} = \set{x}$, as required by the definition of $\wbc$ (\mydefref{def:wbc}).
%			\newc{JP - I have modified here, please check.}
		...
		\item	Case $\ell = \news{\widetilde{m_1}'} \bactout{n}{\abs{\widetilde{x}}{P}}$: This case is similar to the previous case but makes use of the alternative trigger, $\ntrigger{t}{V}$ (cf.~\eqref{eq:ntrig}).
			The definition of $\Re$ and transition \eqref{lem:wb_is_wbc1} allow us to infer the existence of $Q$ and $Q_2$ such that
			%
			\[
...
%				\JP{It is not clear what case you are referring to here} we can conclude that :
			...
			\]
			for all $R$ with $\fpv{R} = x$, as required by the definition of $\wbc$ (cf. \defref{def:wbc}).\\
...
\item	{\bf Reduction-Closed:}
	...
	\]
%
	\noi implies that there exists a $P_2'$ such that 
  \[
...
\]
%
	\noi implies the existence of $V_2$ and $P'_2$ such that
%
	\begin{eqnarray*}
...
$		\Gamma; \emptyset; \Delta_2 \proves P_2 \Barb{n}$, as desired.
	...
	\item {\bf Congruence:} We have to show that  $\wbc$
	is preserved under any context. The most interesting context case is parallel composition; 
we construct an appropriate typed relation defined as 
	\[
	\begin{array}{rcl}
		\mathcal{S} &=&	\set{
	...
	\horel{\Gamma}{\Delta_1 \cat \Delta_3}{\newsp{\widetilde{n_1}}{P_1 \Par R}}
					...
					$$
	We have to show an appropriate matching action from $\newsp{\widetilde{n_2}}{P_2 \Par R}$.
		...
		\item Suppose that $\ell$ originates in $P_1$:
				...
				\begin{enumerate}[i.]
					...
					%
							...
							\]
							\noi which implies the existence of a $P_2'$ such that
							\begin{eqnarray}
					...
					Then we infer the typed transition 
							\[
								...
								{\Delta_1'}{P_1'}
							\]
							which implies the existence of $P'_2$ and $\Delta_2''$ such that 
							\begin{equation}
						...
						\begin{equation}
							...
							\end{equation}
					for all $Q$, with  $\set{x} \in \fpv{Q}$.  From transition~\eqref{lem:wbc_is_cong3}, we infer that 
							\[
								\horel{\Gamma}{\Delta_2 \cat \Delta_3}{\newsp{\widetilde{n_2}}{P_2 \Par R}}
				 ...
				 Furthermore, from~\eqref{lem:wbc_is_cong4} we conclude that 
					%
							...
							\]
				for all $Q$, with  $\set{x} \in \fpv{Q}$, as desired. \\
 ...
 From the definition of typed transition we infer that
							\[
								...
								{\Delta_1'}{P_1'}
							\]
							which, in turn, implies that there exist $P_2', m_2$ such that
					%
							\begin{equation}
					...
					%
						...
						\]
					for all $Q$ with $x = \fn{Q}$, as desired.
				\end{enumerate}
	%%%%%%%%%%%%%%%
	% Case 2
	%%%%%%%%%%%%%%%
	...
	\Gamma; \emptyset; \Delta_3'' \proves \newsp{\widetilde{m}'}{R' \Par R_1 \subst{\abs{\widetilde{x}}{Q}}{x}} \hastype \Proc
						...
						\end{equation}
						for all $R_1$ with $\set{x} = \fpv{R_1}$. Now, from~\eqref{lem:wbc_is_cong7} we obtain that
						\[
						...
						\]
						 for all $R_1$ with $\set{x} \in \fpv{R_1}$, as desired. \\
				...
				\Gamma; \emptyset; \Delta_3'' \proves \newsp{\widetilde{m}'}{R' \Par Q \subst{\widetilde{m}}{\widetilde{x}}} \hastype \Proc
					...
					\end{equation}
					 for all $Q$ with $\widetilde{x} = \fn{Q}$.
				Now, from~\eqref{lem:wbc_is_cong9}, we obtain that
					...
					\[
						...
						{\Delta_2 \cat \Delta_3''}{}{\newsp{\widetilde{m_2}}{P_2 \Par \newsp{\widetilde{m}'}{R' \Par Q \subst{\widetilde{m}}{\widetilde{x}}}}}
					\]
					 for all $Q$ with $\widetilde{x} = \fn{Q}$, as required.
			\end{enumerate}
...
%							\label{lem:wbc_is_cong11} \\
						...
						\end{eqnarray}
 From~\eqref{lem:wbc_is_cong11} and~\eqref{lem:wbc_is_cong12} we obtain
						\[
							\horel{\Gamma}{\Delta_2 \cat \Delta_3}{\newsp{\widetilde{m_2}}{P_2 \Par R}}
							{\By{}}
							{\Delta_2' \cat \Delta_3'}{\newsp{\widetilde{m_2}'}{P_2' \Par R'}}
				...
				\item   $\ell_1 = {\news{\widetilde{m_1}} \bactout{n}{\abs{\widetilde{x}}{Q_1}}}$: Then we have the transition
					...
					%
						...
						\end{eqnarray}
				In turn, the output transition from $P_1$ implies the existence of $Q_2$, $P'_2$ such that
							\begin{eqnarray}
						...
						which may be combined with~\eqref{lem:wbc_is_cong15} to obtain
						\[
							\horel{\Gamma}{\Delta_2 \cat \Delta_3}{\newsp{\widetilde{m_2}}{P_2 \Par R}}
							{\By{}}
						...
						\]
					%
						\noi We conclude by setting $Q$ as $R'$  in~\eqref{lem:wbc_is_cong16} so as to obtain:
					%
				...
				\item $\ell_1 = {\news{\widetilde{mm_1}} \bactout{n}{\widetilde{m_1}}}$. Then we have the transition
					...
					which implies 
						\begin{eqnarray}
							...
							\nonumber 
							\end{eqnarray}
							In turn, the output transition from $P_1$ implies the existence of $P_2$, $\widetilde{m_2}$ such that
							\begin{eqnarray}
							 & \horel{\Gamma}{\Delta_2}{P_2}
							{\By{\news{\widetilde{mm_2}} \bactout{n}{\widetilde{m_2}}}}
							{\Delta_2'}{P_2'}
...
\begin{lemma}[Extrusion]\rm
	...
	\]
	with 
	 $\widetilde{m_1} = \fn{V_1}$ and $\widetilde{m_2} = \fn{V_2}$
	then there exist $\Delta_1, \Delta_2$ such that
	\[
...
%							\]
							%
							\noi Applying reduction closeness to the above pair we infer:
							%
							\[
			...
			%% Subcase i
				...
				We then obtain
					%
						...
						\end{eqnarray*}
					%
						From~(\ref{lem:cong_is_wb2}) we may now infer:
					%
						\begin{eqnarray*}
					...
					%
						...
						\]
						We then apply \mylemref{lem:extrusion} to obtain
					%
						\[
							\horel{\Gamma}{\Delta_1'}{P_1'}{\cong}{\Delta_2'}{P_2'} \text{ implies } \horel{\Gamma}{\Delta_1'}{P_1'}{\ \Re\ }{\Delta_2'}{P_2'}
						\]
...
The transition from $P_1$ can be then written as 
					...
					%
						...
						\end{eqnarray*}
					%
						\noi Using~(\ref{lem:cong_is_wb2}) we may then infer
					%
						\[
