				...
				\begin{itemize}
					\item	Case $\ell = \news{\widetilde{m_1}} \bactout{n}{V_1}$ is the non-trivial case.
						...
						%
							...
							\end{eqnarray}
						%
							\noi which follows from \eqref{lem:wb_eq_wbf3}, Part 1 of \lemref{lem:trigger_equiv},
				...
				\begin{itemize}
					\item	Case $\ell = \news{\widetilde{m_1}} \bactout{n}{V_1}$ is the non-trivial case.
						...
						%
							...
							\end{eqnarray}
						%
							which follows from \eqref{lem:fwb_sub_hbf3}, Part 2 of \lemref{lem:trigger_equiv},
							and the definition of $\Re$.
...
\begin{lemma}[Trigger Substitution]
	...
	Let fresh $t$. If
	\[
		\horel{\Gamma}{\Delta_1}{\newsp{\widetilde{m_1}}{P_1 \Par \appl{(\trvalx{t})}{n_1} }}
		{\hwb}
		{\Delta_2}{\newsp{\widetilde{m_2}}{P_2 \Par \appl{(\trvalx{t})}{n_2} }}
	\]
	then $\forall \abs{x}{R}, \exists \Delta_1', \Delta_2'$ such that
	\[
		\horel{\Gamma}{\Delta_1'}{\newsp{\widetilde{m_1}}{P_1 \Par \appl{(\abs{x}{R})}{n_1} }}
		{\hwb}
		{\Delta_2'}{\newsp{\widetilde{m_2}}{P_2 \Par \appl{(\abs{x}{R})}{n_2} }}
	\]
\end{lemma}
...
\begin{proof}
	...
	\begin{enumerate}
		\item	Case $P_1 \not\scong Q \Par \appl{x}{n}$.
				...
				in the cases where $\ell_1 = \news{\widetilde{m}} \bactout{n}{V_1}$ (resp., $\ell_2 = \news{\widetilde{m}'} \bactout{n}{V_2}$)
				and $C_1 = C_2 = \inact$ otherwise.
				Because $C_1$ and $C_2$ are closed terms we can write
				\begin{eqnarray*}
