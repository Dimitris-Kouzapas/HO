...
We analyse each part separately:
	\begin{enumerate}[1.]
		\item	The proof for Part 1 is  by contradiction.
				...
				Note that the shape of $\mapchar{U}{n_1}$ enables an observable action on $n_1$, which 
				...
				\[
					...
					&\hby{\bactinp{t}{\omapchar{\shot{U}}} }&
					\newsp{\widetilde{m_1}}{P \Par  \appl{\abs{x}{\mapchar{U}{x}} }{n_1}} \\
					&\hby{\dtau} \hby{\ell}&
					\Delta_1' \proves \newsp{\widetilde{m_1}}{P \Par C \Par \bout{t'}{n_1} \inact }
					\end{array}
%>>>>>>> aef27afeb4589c34c9d95590db19c7f7ff07237c
				\]
%				\JP{Why do we skip the tau related to beta-reduction?}
				where $C = \inact$ if $\ell$ is not an input action, and 
				$C = \mapchar{U'}{m}$ if $\ell$ is an input action and $\subj{\ell} = n_1$. Because of the characteristic process interaction,
%				\JP{Why? I think $\ell_1$ can come from $P$ and be different from $n_1$..}
			  from the freshness of $t$, we have:
				\[
					\horel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \appl{(\trvalx{t})}{n_2} }}
%<<<<<<< HEAD
%					{ \Hby{ \bactinp{t}{\omapchar{U}}  } \Hby{\mact{\ell}} }
%					{\Delta_2'}{\newsp{\widetilde{m_2}}{Q' \Par C \Par \appl{\omapchar{U}}{n_2}}}
%=======
					{ \Hby{ \bactinp{t}{\omapchar{\shot{U\,}}}  } \Hby{\mact{\ell}} }
					{\Delta_2'}{\newsp{\widetilde{m_2}}{Q' \Par C \Par \appl{\omapchar{\shot{U}}}{n_2}}}
%>>>>>>> aef27afeb4589c34c9d95590db19c7f7ff07237c
				\]
				with $\subj{\mact{\ell}} = n_2$ %\JP{Here again, why?}
				But since 
%<<<<<<< HEAD
%				$\newsp{\widetilde{m_1}}{P \Par C \Par \bout{t'}{n_1} \inact }$ has an action on $t'$ 
%				not present in $\newsp{\widetilde{m_2}}{Q' \Par C \Par \appl{\omapchar{U}}{n_2}}$, we derive a contradiction with respect to the bisimilarity assumption.
%=======
				$\newsp{\widetilde{m_1}}{P \Par \bout{t'}{n_1} \inact }$ has an action on $t'$ 
				not present in $\newsp{\widetilde{m_2}}{Q' \Par C \Par \appl{\mapchar{\shot{U}}}{n_2}}$, we derive a contradiction with respect to the bisimilarity assumption.
%>>>>>>> aef27afeb4589c34c9d95590db19c7f7ff07237c
		...
		\item	For the proof of Part 3 we do a case analysis on the transitions for checking the bisimulation requirements. 
		The most interesting case is when, for some $\Delta''_1$:
				\[
							...
							\begin{itemize}
								...
								\item	$\subj{\ell_{11}'} = n_1$.
										...
										\[
											...
											{ \hby{\bactout{t}{n_1}} }
%<<<<<<< HEAD
%											{\Delta_1''''}{}{\newsp{\widetilde{m_1}''}{P \subst{n}{x} \Par \mapchar{U}{x} \subst{n_1}{x}}}
%=======
											{\Delta_1''''}{}{\newsp{\widetilde{m_1}''}{P \subst{n}{x}}}
%>>>>>>> aef27afeb4589c34c9d95590db19c7f7ff07237c
										\]
										for some $\Delta''''_1$
										which implies
										\[
											...
											{ \Hby{\bactout{t}{m_1}} }
%<<<<<<< HEAD
%											{\Delta_2''''}{}{\newsp{\widetilde{m_2}''}{Q' \subst{n}{x} \Par \mapchar{U}{x} \subst{m_1}{x}}}
%=======
											{\Delta_2''''}{}{\newsp{\widetilde{m_2}''}{Q' \subst{n}{x}}}
%>>>>>>> aef27afeb4589c34c9d95590db19c7f7ff07237c
										\]
										for some $\Delta''''_2$
										with
										...
										\[
											\mhorel{\Gamma}{\Delta_1''}{\newsp{\widetilde{m_1}''}{P \subst{n}{x} \Par \mapchar{U}{x} \subst{n_1}{x}}}
											{ \hby{\tau} }
											{\Delta_1'''}{}{\newsp{\widetilde{m_1}''}{P_2 \subst{n}{x} \Par C_1 \Par \bout{t'}{n_1} \inact}}
										\]
										where $C_1 = \inact$ if the action on $\mapchar{U}{x} \subst{n_1}{x}$ is not an input
										action and $C_1 = \mapchar{U'}{a}$ otherwise.
										This in turn implies from Part 2 of this lemma
										\begin{eqnarray}
											\mhorel{\Gamma}{\Delta_2''}{\newsp{\widetilde{m_2}''}{Q' \subst{n}{x} \Par \mapchar{U}{x} \subst{m_1}{x}}}
											{\Hby{\tau}}
											{\Delta_2'''}{}{\newsp{\widetilde{m_2}''}{Q_2 \subst{n}{x} \Par C_2 \Par \bout{t'}{m_1} \inact}}
											\label{lem:tr_app_44}
										\end{eqnarray}
										for some $\Delta'''_2$ and $C_2 = \inact$ when the action on $\mapchar{U}{x} \subst{m_1}{x}$ is not an input
										action and $C_2 = \mapchar{U'}{b}$ otherwise.
										...
										\[
											\newsp{\widetilde{m_2}''}{Q' \subst{n}{x} \Par \mapchar{U}{x} \subst{m_1}{x}}
											\Hby{ \ell_{22}'' }
											\newsp{\widetilde{m_2}''}{Q_2 \subst{n}{x} \Par \mapchar{U}{x} \subst{m_1}{x}}
										\]
										and furthermore,
										\[
											\newsp{\widetilde{m_2}''}{Q' \subst{m_1}{x}}
										...
										\[
											\horel{\Gamma}{\Delta_1'''}{\newsp{\widetilde{m_1}''}{P_2 \subst{n}{x} \Par C_1 \Par \bout{t'}{n_1} \inact}}
											{\hby{\ell_{12}''}}
											{\Delta_3}{\newsp{\widetilde{m_1}'''}{P' \subst{n}{x} \Par C_1 \Par \bout{t'}{n_1} \inact}}
										\]
										which implies
										\[
											\horel{\Gamma}{\Delta_2'''}{\newsp{\widetilde{m_2}''}{Q_2 \subst{n}{x} \Par C_2 \Par \bout{t'}{m_1} \inact}}
											{\hby{\ell_{22}''}}
											{\Delta_4}{\newsp{\widetilde{m_2}'''}{Q'' \subst{n}{x} \Par C_2 \Par \bout{t'}{m_1} \inact}}
										\]
										and
										\begin{eqnarray*}
											\horel{\Gamma}{\Delta_3}{\newsp{\widetilde{m_1}'''}{P' \subst{n}{x} \Par C_1 \Par \bout{t'}{n_1} \inact}}
											{\hwb}
											{\Delta_4}{\newsp{\widetilde{m_2}'''}{Q'' \subst{n}{x} \Par C_2 \Par \bout{t'}{n_1} \inact}}
										\end{eqnarray*}
...
%							The proof is a consequence of Part 3 \lemref{lem:trigger_application}.
							From the requirement of $\Re$ we get that there exists $\shot{U}$
							such that, for some $\Delta_3$:
							\[
								\mhorel{\Gamma}{\Delta_1}{ \newsp{\widetilde{m_1}}{P \Par \prod_{i \in I} \binp{t_i}{x} (\appl{x}{n_i})}}
								{ \hby{ \bactinp{t_k}{ \omapchar{\shot{U}} }} \Hby{\dtau} }
							...
							obtain that if, for some $\Delta_3'$ and some  $\omapchar{U'}$ (cf. \defref{def:char}), 
							we have
							\[
							\mhorel{\Gamma}{\Delta_3}{  \newsp{\widetilde{m_1}'}{P \Par \prod_{i \in I\backslash{\set{k}}} \binp{t_i}{x} (\appl{x}{n_i})
									\Par  \mapchar{U}{x} \subst{n_k}{x} }}
