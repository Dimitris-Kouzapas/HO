...
\begin{proof}[Sketch] The proof proceeds by mutual induction on the syntax of types.
	\begin{enumerate}
		\item	The proof relies on the results from Parts 2 and 3.
...
\begin{itemize}
		...
		\item First direction. Let $\Re$ be the typed relation (we omit the type information):
				...
				\begin{enumerate}
					...
					\item	An action along $t$. Let $\omapchar{U} = n$:
							...
							\]
							\newc{JP: Why $Q$ doesn't move in the above weak transition?} and
							\[
								\horel{\Gamma}{\Delta_3'}{\newsp{\widetilde{m_1}'}{P \Par \newsp{s}{\binp{s}{y}{(\appl{y}{n})} \Par \bout{\dual{s}}{V_1} \inact}}}
								{\hby{\dtau}}
	...
	\horel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \ntrigger{t}{V_2}  } }
						...
						\item	An action along $t$. Let $\omapchar{U} = \abs{z}{\mapchar{U'}{z}}$: 
							...
							\]
							\newc{JP: Also above $Q$ should move. I think the parenthesis for the abstraction are not OK.} and
							\[
								\horel{\Gamma}{\Delta_3'}{\newsp{\widetilde{m_1}'}{P \Par \newsp{s}{\binp{s}{y}{(\appl{y}{n})} \Par \bout{\dual{s}}{V_1} \inact}}}
								{\hby{\dtau}}
