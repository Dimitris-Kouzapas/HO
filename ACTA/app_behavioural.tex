...
\begin{lemma}
	\label{app:lem_trigger_equiv}
	Let $t$ be a fresh name and
	$\Gamma; \es; \Delta_{V_i} \proves V_i \hastype U, i \in \set{1, 2}$.
				...
				\begin{itemize}
					\item	Case $\ell = \news{\widetilde{m_1}} \bactout{n}{V_1}$ is the non-trivial case.
						...
						%
							...
							\end{eqnarray}
						%
							\noi \dk{which follows from \eqref{lem:wb_eq_wbf3} and Part 1 of \lemref{app:lem_trigger_equiv}.}
				...
				\begin{itemize}
					\item	Case $\ell = \news{\widetilde{m_1}} \bactout{n}{V_1}$ is the non-trivial case.
						...
						%
							...
							\end{eqnarray}
						%
							\noi \dk{which follows from \eqref{lem:fwb_sub_hbf3} and Part 2 of \lemref{app:lem_trigger_equiv}.}
