	...
	\begin{enumerate}
		\item	$\ell = \news{\widetilde{m_1}} \bactout{n}{V_1}$ is the non-trivial case.
			...
			%
				...
				\end{eqnarray}
			%
				\noi Result \eqref{lem:wb_eq_wbf3} can be shown, by showing that the processes in \eqref{lem:wb_eq_wbf3}
		...
		\item	The rest of the cases are trivial.
	\end{enumerate}
...
\begin{proof}
	Let typed relation (we ommit typing judgements from the definition)
	\[
...
\begin{proof}
	\noi Let typed relation (we ommit the typing information in the definition):
	\[
