...
\begin{proof}
	\begin{enumerate}
		\item	The proof for Part 1 is done by contradiction. Assume that $\dual{n_1} \in \fn{P}$ and $\dual{n_2} \in \fn{Q}$.
				Then the bisimulation requirement allows us to observe:
