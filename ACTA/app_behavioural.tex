...
\begin{proof}
	...
	\begin{enumerate}
				...
				\begin{enumerate}[i.]
					...
					\item	$\subj{\ell} = n_k$ and $n_k = m_k$.
							...
							\begin{eqnarray*}
								...
								\\
								&\hwb&
									\Delta_4 \proves \newsp{\widetilde{m_1}}{Q' \Par  \Par \prod_{i \in I \backslash{\set{k}}} \binp{t_i}{x} \appl{x}{m_i} \mapchar{U}{x} \subst{m_k}{x}}
							\end{eqnarray*}
		...
		\item	\[
					\horel{\Gamma}{\Delta_1'}{\newsp{\widetilde{m_1}}{P \Par R \subst{\widetilde{n}}{\widetilde{x}} }}
					{\hby{}}
					{\Delta_1''}{\newsp{\widetilde{m_1}'}{P' \Par R' \subst{\widetilde{m}}{\widetilde{x}} }}
				\]
				...
				\begin{enumerate}[i.]
					...
					\item	The most demanding sub-case is the case
							where $\ell_1 = \bactinp{n_k}{n_l}$ and $\ell_2 = \bactout{n_k}{n_l}$.
				\end{enumerate}
	\end{enumerate}
	\qed
\end{proof}
