			...
			\item	Case $S = \trec{t}{S'}$.
					...
					\begin{enumerate}
						...
						\item	$S' = \trec{t'}{S''}$
								...
								If $\mapchar{S'' \subst{\tinact}{\vart{t}} \subst{\tinact}{\vart{t'}}  }{s} = \inact$ then the proof is straightforward.

								If $\delete{S} = \set{S_i}_{i \in I}$ then by induction
								\[
									\tree {
										\textrm{Induction}
									}{
