...
\begin{proof}[Sketch]
	The proof of part 1 is done by induction on the the syntax of $S$. We give
	some notable cases.
	\begin{itemize}
...
\begin{proof}
	\begin{enumerate}
		...
		\item	For the proof for Part 3 we need to create a relation and prove that is a higher order bisimulation.

				\dk{finish proof}

		\item	Part 4 requires
