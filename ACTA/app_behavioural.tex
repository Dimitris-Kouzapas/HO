...
%					\horel{\Gamma}{\Delta_1'}{P_2 \subst{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}{x}}{\hwb}{\Delta_2'}{Q_2 \subst{\abs{\widetilde{x}}{\mapchar{U}{\widetilde{x}}}}{x}}\\
 ...
 transition \eqref{lem:wb_is_wbc1} and $\Re$ imply the existence of a $\Delta'_2$, a process $Q_2$, and name $m_2$ such that 
			%
			\[
			...
			\]
			 for some fresh $t$.
				...
				we can conclude that for all $R$ with $\fpv{R} = \set{x}$ and for some $\Delta_1''$, $\Delta_2''$:
			%
			\[
				\begin{array}{rcl}
					\Gamma; \es; \Delta_1' \proves \newsp{\widetilde{m_1}'}{P_2 \Par \htrigger{t}{m_1}} 
...
we construct an appropriate typed relation defined as 
		...
		\item Suppose that $\ell$ originates in $P_1$:
				...
				\begin{enumerate}[i.]
					...
					%
							...
							\]
							\noi which implies the existence of a $P_2'$ and a $\Delta_2'$ such that
							\begin{eqnarray}
					...
					Then we infer the typed transition 
							\[
								...
								{\Delta_1'}{P_1'}
							\]
							which implies the existence of $P'_2$, $\Delta_2'$, and $\Delta_2''$ such that 
							\begin{equation}
 ...
 From the definition of typed transition we infer that
	...
	\Gamma; \emptyset; \Delta_3'' \proves \newsp{\widetilde{m}'}{R' \Par R_1 \subst{\abs{\widetilde{x}}{Q}}{x}} \hastype \Proc
						...
						\end{equation}
						for some $\Delta_3''$ and for all $R_1$ with $\set{x} = \fpv{R_1}$. Now, from~\eqref{lem:wbc_is_cong7} we obtain that
						\[
				...
				\Gamma; \emptyset; \Delta_3'' \proves \newsp{\widetilde{m}'}{R' \Par Q \subst{\widetilde{m}}{\widetilde{x}}} \hastype \Proc
					...
					\end{equation}
					 for all $Q$ with $\widetilde{x} = \fn{Q}$, for some $\Delta_3''$.
...
for some $\Delta_2'$. From~\eqref{lem:wbc_is_cong11} and~\eqref{lem:wbc_is_cong12} we obtain
				...
				In turn, the output transition from $P_1$ implies the existence of $\Delta_2'$, $Q_2$, $P'_2$ such that
						...
						\end{eqnarray}
						 for all $Q$ with $\set{x} = \fpv{Q}$, and for some $\Delta_1''$ and $\Delta_2''$.
						...
						\]
					%
						for some $\Delta_3''$. We conclude by setting $Q$ as $R'$  in~\eqref{lem:wbc_is_cong16} so as to obtain:
					%
