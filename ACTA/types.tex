...
\newc{Intuitive definitions of these structural principles follow. Exchange indicates that the ordering of type assignments does not matter. 
Weakening says that type assignments need not be used. 
Finally, contraction  says that type assignments may be duplicated.
