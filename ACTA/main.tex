...
%%% Revised version after reviewers feedback
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{hyperref}
\hypersetup{colorlinks,urlcolor=red,citecolor=blue}
\input{macros}
%\bibliographystyle{plain}% the recommended bibstyle

% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Characteristic Bisimulation for Higher-Order Session Processes}
%\titlerunning{Characteristic Bisimulation for Higher-Order Session Processes (\today)}
\titlerunning{Characteristic Bisimulation for Higher-Order Sessions (\today)}
