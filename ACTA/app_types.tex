...
\newc{Below, shared value means that there are no free linear names, thus $\Lambda, \Delta$ are empty (cf. Rule $\trule{Prom}$).}
...
Since we are working with synchronous communication such an ordering can be omitted. 
