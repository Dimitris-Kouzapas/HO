...
%
\begin{proof}[Sketch]
	The proof requires a case analysis on the structure of
	\betatran and session-transition.
...
it allows us to use $\hwb$ and $\fwb$ as tractable reasoning %is the most tractable 
...
%	by using an up-to determinate technique; 
...
\begin{proof}[Sketch]	
	...
	\]
%	defined in \defref{app:def:definibility}.
...
%	See \appref{app:sub_coinc} and~\cite{KouzapasPY15} for full details.
%\end{proof}
