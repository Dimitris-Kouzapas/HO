...
barbed congruence, the form of contextual equivalence used in concurrency 
(denoted $\cong$, cf. \defref{def:rc}).
...
As it will be clear below (cf. \defref{d:typedrel}), we will be working with closed process terms, i.e., processes with no free  variables.
}
