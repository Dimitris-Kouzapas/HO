...
\begin{proof}
	...
	\lemref{lem:wb_eq_wbf} (which proves $\wb\ =\ \wbf$), 
	\lemref{lem:wb_is_wbc} (which proves $\wb\ \subseteq\ \wbc$),
	\lemref{lem:wbc_is_cong} (which proves $\wbc\ \subseteq\ \cong$), and	
	\lemref{lem:cong_is_wb} (which proves $\cong\ \subseteq\ \wb$).
%
%\begin{enumerate}[$-$]
...
%		\end{enumerate}
Indeed, we may conclude $$\cong\ \subseteq\ \wb\ =\ \wbf\ \subseteq\ \wbc\ \subseteq\ \cong$$
	\qed
\end{proof}
