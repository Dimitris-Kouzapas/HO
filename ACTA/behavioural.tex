...
\begin{proof}[Sketch]
	...
	need to use \lemref{lem:trigger_subst}, which shows that if
	\[
	...
	\]
	The proof for the above lemma follows the definition of the characteristic process.
	The sketch of proof requires to construct a relation
	\begin{eqnarray*}
		\Re &=& \set{
					\horel{\Gamma}{\Delta_1'}{\newsp{\widetilde{m_1}}{P \Par \appl{(\abs{x}{R})}{n_1} }}
					{\ ,\ }
	...
	\end{eqnarray*}
	The proof that $\Re$ is a higher-order bisimulation then follows the transitions:
	\[
	\begin{array}{rcll}
		...
		\\
		\hby{\ell_1}
		&& \newsp{\widetilde{m_1}'''}{P' \Par \bout{t'}{n_1} \inact } \qquad \qquad  \qquad \textrm{\small By Characteristic Process Definition}
		\\
		\hby{\bactout{t}{n_1}} \Hby{\dtau} \hwb
		&&
		\Delta_1' \proves \newsp{\widetilde{m_1}'}{P' \Par \appl{(\trvalx{t'})}{n_1} }
	\end{array}
	\]
	which due to the bisimulation requirement in the definition of $\Re$ we get
	\[
		\mhorel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \appl{(\trvalx{t})}{n_2} }}
		{\Hby{\bactinp{t}{\omapchar{U}}} \dots \hby{\ell_2} \dots}
		{\Delta_2'}{}{\newsp{\widetilde{m_2}'}{Q' \Par \appl{(\trvalx{t})}{n_2} }}
	\]s
