...
\label{ss:elts}
We define a typed LTS which results by coupling the untyped LTS given before with a labelled transition relation 
...
%
	\begin{enumerate}[1)]
		\item 
				Whenever 
				$\horel{\Gamma}{\Delta_1}{P_1}{\hby{\news{\widetilde{m_1}} \bactout{n}{\dk{V_1: U_1}}}}{\Delta_1'}{P_2}$ 
				then there exist 
				$Q_2$, $V_2$, $\Delta'_2$ such that 
				$\horel{\Gamma}{\Delta_2}{Q_1}{\Hby{\news{\widetilde{m_2}}\bactout{n}{\dk{V_2: U_2}}}}{\Delta_2'}{Q_2}$
				and, for fresh $t$,
%
				\[
