...
\begin{proof}[Sketch]
	...
	\]
	The proof for the above lemma follows the syntax of the characteristic process.
	...
	\begin{array}{rcll}
		...
		\\
		\hby{\ell}
		&& \newsp{\widetilde{m_1}'''}{P' \Par \bout{t}{n_1} \inact } & \textrm{\small Characteristic Process Definition}
		\\
	...
	\end{array}
	\]
	which can be mimicked by the second typing judgement:
	\[
		\horel{\Gamma}{\Delta_2}{\newsp{\widetilde{m_2}}{Q \Par \appl{(\trvalx{t})}{n_2} }}
		{\Hby{\bactinp{t}{\omapchar{U}}} \dots}
		{\Delta_2'}{\newsp{\widetilde{m_2}'}{Q' \Par \appl{(\trvalx{t})}{n_2} }}
	\]s
