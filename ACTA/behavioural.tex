...
\begin{example}[Session Environment Confluence]
	...
	and
	$\Delta_2 = \set{s_1: T_1 \cat s_2: \btout{U_1} \btinp{U_2} \tinact \cat \dual{s_2}: \btout{U_1} \btout{U_2} \tinact}$.
	Then $\Delta_1 \red \set{s_1: T_1 \cat s_2: \tinact \cat \dual{s_2}: \tinact}$
	and $\Delta_2 \red \red \set{s_1: T_1 \cat s_2: \tinact \cat \dual{s_2}: \tinact}$
	thus $\Delta_1$ and $\Delta_2$ are confluent.
	\qed
\end{example}
