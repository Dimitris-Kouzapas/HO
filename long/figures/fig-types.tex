...
%		\\[4mm]
		...
		\trule{RcvH}~~\tree{
			...
			\Gamma; \Lambda_1 \backslash \Lambda_2; \Delta \cat k: \btinp{L} S \proves \binp{k}{X} P \hastype \Proc
		}
		\\[6mm]
...
%		\\[6mm]
		...
		\trule{AccH}~~\tree{
			...
			\Gamma; \Lambda_1 \backslash \Lambda_2; \Delta \proves \binp{k}{X} P \hastype \Proc
		}
		\\[6mm]
