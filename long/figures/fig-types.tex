...
%		\\[4mm]
		...
		\trule{Req}~~\tree{
			\begin{array}{c}
				\Gamma; \es; \es \proves k \hastype \chtype{U_1} %\tilde{\chtype{S_1}}
				\quad
				\Gamma; \Lambda; \Delta_1 \proves P \hastype \Proc
				\quad
				\Gamma; \es; \Delta_2 \proves V \hastype U_2%\tilde{S_2}
				\\
...
%		\\[6mm]
		...
		\trule{AccS}~~\tree{
			\Gamma; \emptyset; \emptyset \proves k \hastype \chtype{\tilde{C}}
			\quad
			\Gamma; \Lambda_1; \Delta_1 \proves P \hastype \Proc
			\quad
			\Gamma; \Lambda_2; \Delta_2 \proves \tilde{x} \hastype \tilde{C}
		}{
...
\qquad \quad
		\trule{Var}~~\tree{
			...
			\Gamma \cat \rvar{X}: \Delta; \emptyset; \emptyset  \proves \rvar{X} \hastype \Proc
		}
		\qquad\quad 
%	 	\trule{Rec}~~\tree{
