...
%		\\[4mm]
		...
		\trule{RcvS}~~\tree{
			\Gamma; \Lambda; \Delta \cat k: S \cat \tilde{x}: \tilde{C} \proves P \hastype \Proc
%			\quad
%			\Gamma; \es; \Delta_2 \proves \tilde{x} \hastype \tilde{C}
		}{
			\Gamma; \Lambda; \Delta \cat k: \btinp{\tilde{C}} S \vdash \binp{k}{\tilde{x}} P \hastype \Proc
		}
		\quad
		\trule{RcvH}~~\tree{
			\Gamma \cat X: L; \Lambda_1; \Delta \cat k: S \proves P \hastype \Proc
			\quad
			\Gamma; \Lambda_2; \es \proves X \hastype L
		}{
			\Gamma \backslash X: L; \Lambda_1 \backslash \Lambda_2; \Delta \cat k: \btinp{L} S \proves \binp{k}{X} P \hastype \Proc
		}
		\\[6mm]
...
%			\Gamma; \Lambda_2; \Delta_2 \proves x \hastype S
			...
			\Gamma; \Lambda; \Delta \proves \binp{k}{x} P \hastype \Proc
		}
		\\[6mm]
		...
		\trule{AccH}~~\tree{
			...
			\Gamma \backslash X: L; \Lambda_1 \backslash \Lambda_2; \Delta \proves \binp{k}{X} P \hastype \Proc
		}
		\\[6mm]
