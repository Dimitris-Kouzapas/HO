...
\[
	\recp{X}{\bout{n}{m} r} \scong \bout{n}{m} \recp{X}{\bout{n}{m} r}
\]
...
\[
	\bout{a}{n} \inact \Par \recp{r}{\binp{a}{x} \bout{x}{m} (\bout{a}{x} \inact \Par r)} \red \bout{n}{m} (\bout{a}{n} \inact \Par \recp{r}{\binp{a}{x} \bout{x}{m} (\bout{a}{x} \inact \Par r))}
\]
...
%	\map{r}^{2} &=& \newsp{s}{\appl{\X}{s \cat \smap{\fn{P}}} \Par \bout{\dual{s}}{ \abs{z \cat \vmap{\fn{P}}}{\appl{X}{z \cat \vmap{\fn{P}}}}} \inact} \\
		\pmapp{\rec{X}{P}}{2}{f} &\defeq& \newsp{s}{\binp{s}{\X} \pmapp{P}{2}{{f,\{r\to \tilde{n}\}}} \Par \bbout{\dual{s}}{\abs{\vmap{\tilde{n}}, z } \,{\binp{z}{\X} \auxmapp{\pmapp{P}{2}{{f,\{r\to \tilde{n}\}}}}{\mathsf{v}}{\es}}} \inact} & \quad \tilde{n} = \ofn{P} \\ 
		\pmapp{r}{2}{f} &\defeq& \newsp{s}{\appl{\X}{\tilde{n}, s} \Par \bbout{\dual{s}}{ \abs{\vmap{\tilde{n}},z}\,\,{\appl{X}{ \vmap{\tilde{n}}, z}}} \inact} & \quad \tilde{n} = f(r) \\
...
\begin{remark}\rm
	...
	\[
		\tmap{\Gamma \cat r:\Sigma}{2} = \tmap{\Gamma}{2} \cat X:\shot{(\tilde{S}_{\Sigma}, S^*)}
...
\begin{proof}
	...
	\begin{enumerate}[1.]
		\item Case $P_0 = r$. Then we have the following typing in the source language:
	
		{\small
		\[
		\tree{
		}{
		\Gamma \cat r: \Sigma ;\, \es ;\, \es \proves r \hastype \Proc
		}
		\]
		}
	
		Then the typing of $\pmapp{r}{2}{f}$ is as follows, assuming $f(r) = \tilde{n}$ and $\tilde{x} = \vmap{\tilde{n}}$.
		...
		\[
		\tree{
		\Gamma \cat r:\Sigma ;\, \es ;\,  \Sigma \proves P \hastype \Proc
		}{
		...
		Then we have the following typing in the target language ---we write $R$ to stand for $\pmapp{P}{2}{{f,\{r\to \tilde{n}\}} }$
...
Below we write $\repl{} P$ as a shorthand notation for $\recp{X}{(P \Par r)}$.
...
%%%% Output of (linear) channel
	...
	\[
		...
		\pmap{P}{3}  \hastype \Proc
			...
			\tmap{\Gamma_2}{3}; \es ; \tmap{\Sigma_2}{3} 
		\proves 
		\binp{a}{y}\binp{y}{x}\pmap{Q}{3} \Par r \hastype \Proc
			}
			}{
			\tmap{\Gamma_1}{3}; \es ; \tmap{\Sigma_2}{3} 
		\proves 
		\recp{X}{(\binp{a}{y}\binp{y}{x}\pmap{Q}{3} \Par r)} \hastype \Proc
			}
			}{
		...
		\newsp{a}{\bout{k}{a}( 
		\pmap{P}{3} \Par 
		\recp{X}{(\binp{a}{y}\binp{y}{x}\pmap{Q}{3} \Par r))}
		} \hastype \Proc
		}
	\]
	}
