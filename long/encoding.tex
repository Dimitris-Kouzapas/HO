		...
		\begin{enumerate}[a)]
			...
			If  $\wtytra{\mapt{\Gamma}^{\mathsf{p}}}{\ell_2}{\mapt{\Delta_1}^{\mathsf{p}}}{\map{P}}{\mapt{\Delta'_1}^{\mathsf{p}}}{Q}$
			   then $\exists \ell_1, P', R$ s.t.  \\
			    ...
			    (iii)~$Q \Hby{} R$, and \\
			    (iv)~$\wbb{\mapt{\Gamma}^{\mathsf{p}}}{\ell}{\mapt{\Delta'_1}^{\mathsf{p}}}{\map{P'}^{\mathsf{p}}}{\mapt{\Delta'_1}^{\mathsf{p}}}{Q}$.
			    \end{enumerate}
\end{proposition}
...
\noi Part (a). We consider some non-trivial cases, using biadic communication:
\begin{enumerate}[1.]
...
\noi Part (b). We consider some non-trivial cases, using biadic communication:
\begin{enumerate}[1.]
