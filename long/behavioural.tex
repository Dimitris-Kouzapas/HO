...
\subsection{Characteristic Process}
...
by the action.
In a similar fashion output on a shared name is described
...
in the type.
Hidden transitions follow the reduction on the session
environment (Definition~\ref{}) as we can see in rule
$\eltsrule{Tau}$.
...
%$\Gamma; \emptyset; \Delta_1\ R\ \Delta_2 \proves P_1\ R\ P_2$
...
\begin{definition}[Reduction-closed, Barbed Congruence]\rm
	Typed relation
%	$\Gamma; \emptyset; \Delta_1\ \mathcal{R}\ \Delta \proves P_1 \ \mathcal{R}\ P_2$
	$\horel{\Gamma}{\Delta_1}{P_1}{\ R\ }{\Delta_2}{P_2}$
...
%				$\Gamma; \emptyset; \Delta_1'\ \mathcal{R}\ \Delta_2' \proves P_1'\ \mathcal{R}\ P_2'$.
				$\horel{\Gamma}{\Delta_1'}{P_1'}{\ R\ }{\Delta_2'}{P_2'}$
...
%			$\Gamma; \emptyset; \Delta_1'\ \mathcal{R}\ \Delta_2' \proves \context{C}{P_1}\ \mathcal{R}\ \context{C}{P_2}$.
	\end{enumerate}
...
%	$\Gamma; \emptyset; \Delta_1\ \mathcal{R}\ \Delta_2 \proves P_1\ \mathcal{R}\ Q_1$.
	$\horel{\Gamma}{\Delta_1}{P_1}{\ R\ }{\Delta_2}{P_2}$.
...
%				\newsp{\tilde{m_2}}{Q_2 \Par R\subst{(\tilde{x}) Q}{X}}
		...
		\item	$\forall \news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}$ such that
			\[
%				\Gamma; \emptyset; \Delta_1 \by{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}} \Delta_1' \proves P_1 \by{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}} P_2
				\horel{\Gamma}{\Delta_1}{P_1}{\by{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}}}{\Delta_1'}{P_2}
			\]
			implies that $\exists Q_2, \tilde{m_2}$ such that
			\[
%				\Gamma; \emptyset; \Delta_2 \By{\news{\tilde{m_2}'} \bactout{n}{\tilde{m_2}}} \Delta_2' \proves Q_1 \By{\news{\tilde{m_2}'} \bactout{n}{\tilde{m_2}}} Q_2
...
%			\]
		...
		\item	$\forall \news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}$ such that
			\[
%				\Gamma; \emptyset; \Delta_1 \hby{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}} \Delta_1' \proves P_1 \hby{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}} P_2
				\horel{\Gamma}{\Delta_1}{P_1}{\hby{\news{\tilde{m_1}'} \bactout{n}{\tilde{m_1}}}}{\Delta_1'}{P_2}
			\]
			%with $s_1: S \in \Delta_1 \vee (\dual{s_2}: S' \in \Delta_2 \wedge S \dualof S')$
			implies that $\exists Q_2, \tilde{m_2}$ such that
			\[
%				\Gamma; \emptyset; \Delta_2 \Hby{\news{\tilde{m_2}'} \bactout{n}{\tilde{m_2}}} \Delta_2' \proves Q_1 \Hby{\news{\tilde{m_2}'} \bactout{n}{\tilde{m_2}}} Q_2
				\horel{\Gamma}{\Delta_2}{Q_1}{\Hby{\news{\tilde{m_2}'} \bactout{n}{\tilde{m_2}}}}{\Delta_2'}{Q_2}
			\]
			%such that
%			\begin{eqnarray*}
...
%				\Gamma; \emptyset; \Delta_1''\ \mathcal{R}\ \Delta_2'' \proves
%				\newsp{\tilde{m_1}'}{P_2 \Par \fotrigger{t}{\tilde{m_1}}}  % \map{S}^{s_1}}
%				\ \mathcal{R}\ 
%				\newsp{\tilde{m_2}'}{Q_2 \Par \fotrigger{t}{\tilde{m_2}}} %\map{S}^{s_2}}
			\]

		\item	$\forall \ell \notin \set{\news{\tilde{m}'} \bactout{n}{m}, \news{\tilde{m}} \bactout{n}{\abs{x}{P}}}$ such that
			\[
				\horel{\Gamma}{\Delta_1}{P_1}{\hby{\ell}}{\Delta_1'}{P_2}
%				\Gamma; \emptyset; \Delta_1 \hby{\ell} \Delta_1' \proves P_1 \by{\ell} P_2
			\]
			implies that $\exists Q_2$ such that 
			\[
				\horel{\Gamma}{\Delta_1}{Q_1}{\Hby{\ell}}{\Delta_1'}{Q_2}
%				\Gamma; \emptyset; \Delta_2 \Hby{\hat{\ell}} \Delta_2' \proves Q_1 \By{\hat{\ell}} Q_2
			\]
			and
			$\horel{\Gamma}{\Delta_1'}{P_2}{\ \mathcal{R}\ }{\Delta_2'}{Q_2}$
%			$\Gamma; \emptyset; \Delta_1\ \mathcal{R}\ \Delta_2 \proves P_2\ \mathcal{R}\ Q_2$.
