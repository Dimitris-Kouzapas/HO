...
%			$\Gamma; \emptyset; \Delta \proves T\lrangle{\emptyset, \emptyset} \hastype \Proc$.
...
%		\item	$T\lrangle{\bactout{n}{\tilde{m}}, \suc} = \binp{\dual{n}}{\tilde{x}} (\binp{t}{X} \appl{X}{\tilde{x}} \Par \bout{\suc}{\dual{n}} \inact)$.
