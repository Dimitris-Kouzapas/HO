...
%
	\begin{eqnarray}
		\Gamma; \es; \Delta_2 &\Hby{\ell_2}& \Delta_2' \proves \newsp{\tilde{m_2}}{Q_1 \Par Q_2 \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}} \nonumber \\
		&\Hby{\ell_2}&
...
%
\[
	\mhorel{\Gamma}{\Delta_1}{\newsp{\tilde{m_1}}{P_1 \Par \appl{X}{\tilde{n}} \subst{\abs{\tilde{x}}{R}}{X}}}{\hby{\ell}}
...
%
	\[
		\mhorel{\Gamma}{\Delta_1''}{\newsp{\tilde{m_1}'}{P_1 \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X} \Par \appl{Y}{\tilde{n}} \subst{\abs{\tilde{x}}{R}}{Y}}}
		{\wb}
		{\Delta_2''}{}{\newsp{\tilde{m_2}'}{(Q_1' \Par Q_2') \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X} \Par \appl{Y}{\tilde{m}} \subst{\abs{\tilde{x}}{R}}{Y}}}
	\]
%
