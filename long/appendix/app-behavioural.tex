...
%
	\[
		\horel{\Gamma}{\Delta_1}{\newsp{\tilde{s_1}}{P_1 \subst{\abs{\tilde{x}}{R}}{X} \Par P_2\subst{\abs{\tilde{x}}{R}}{X} }}{\by{\ell_1}}{\Delta_1'}{P_1'}
...
%\[
%	\begin{array}{rcll}
%		\horel{\Gamma}{\Delta_1}{\newsp{\tilde{s_1}}{P_1 \Par P_2 \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}}}{\by{\ell_1}}{\Delta_1'}{P' \scong & \newsp{\tilde{s_1}}{P_1 \Par P_2' \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}}}
%		\Gamma; \es; \Delta_1 &\by{\ell_1}& \Delta_1' \proves & \newsp{\tilde{s_1}}{P_1 \Par P_2 \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}}\\
%		&\by{\ell_1}&
%		P' \scong & \newsp{\tilde{s_1}}{P_1 \Par P_2' \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}}
%	\end{array}
...
%		\Gamma; \es; \Delta_1' \wb \Delta_2' \proves P' \Par C_1 \wb Q' \Par C_2 
	\end{eqnarray}
%
	\noi Furthermore
%
\[
	\mhorel{\Gamma}{\Delta_1}{\newsp{\tilde{s_1}}{P_1 \Par P_2 \subst{\abs{\tilde{x}}{\map{U}^{\tilde{x}}}}{X}}}{\by{\ell_1}}
...
%
	\begin{eqnarray*}
		\horel{\Gamma}{\Delta_2}{\newsp{\tilde{s_2}}{Q_1 \Par Q_2 \subst{\abs{\tilde{x}}{R}}{X}}}{\By{\ell_2}}{\Delta_2'}{\newsp{\tilde{s_2'}}{Q_1' \Par Q_2' \subst{\abs{\tilde{x}}{R}}{X}}}
...
%
	\begin{eqnarray*}
		\horel{\Gamma'}{\Delta_1''}{\newsp{\tilde{s_2'}}{P_1 \Par P_2' \subst{\abs{\tilde{x}}{R}}{X}} \Par C_1}{\ S\ }{\Delta_2''}{\newsp{\tilde{s_2'}}{Q_1 \Par Q_2' \subst{\abs{\tilde{x}}{R}}{X}} \Par C_2}
...
%
\[
	\mhorel{\Gamma}{\Delta_1}{\newsp{\tilde{s_1}}{P_1 \Par \appl{X}{\tilde{n}} \subst{\abs{\tilde{x}}{R}}{X}}}{\by{\ell}}
...
%
	...
	\begin{eqnarray*}
		&& \horel{\Gamma}
		{\Delta_1'}{\newsp{\tilde{s_1'}}{P_1 \Par \appl{X}{\tilde{n}} \subst{\abs{\tilde{x}}{R' \Par C}}{X}}}
		{\ S\ }
...
%
	\begin{eqnarray*}
		&&\horel{\Gamma}
		{\Delta_1'}{\newsp{\tilde{s_1'}}{P_1 \Par \appl{X}{s} \subst{\abs{\tilde{x}}{R'}}{X} \Par C}}
		{\ S\ }
...
\begin{corollary}\rm
	...
	Let
	\begin{eqnarray*}
		S &=& \set{\horel{\Gamma}{\Delta_1}{P \subst{\abs{\tilde{x}}{R}}{X}}{,}{\Delta_2}{Q \subst{\abs{\tilde{x}}{R}}{X}} \setbar \\
%		\set{\Gamma; \es; \Delta_1, \Delta_2 \proves P \subst{\abs{\tilde{x}}{R}}{X}, Q \subst{\abs{\tilde{x}}{R}}{X} \setbar \\
		...
		&& \quad \textrm{for fresh } t,
		\horel{\Gamma}{\Delta_1'}{P \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}}{\wb}{\Delta_2'}Q \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}, \\
%		\Gamma; \es; \Delta_1' \wb \Delta_2' \proves P \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X} \wb Q \subst{\abs{\tilde{x}}{\binp{t}{Y} \appl{Y}{\tilde{x}}}}{X}, \\
		&& \quad \horel{\Gamma}{\Delta_1''}{P \subst{\abs{\tilde{x}}{\map{U}^{\tilde{x}}}}{X}}{\wb}{\Delta_2''}{Q \subst{\abs{\tilde{x}}{\map{U}^{\tilde{x}}}}{X}} \textrm{ for some } U \\
%		\Gamma; \es; \Delta_1'' \wb \Delta_2'' \proves P \subst{\abs{\tilde{x}}{\map{U}^{\tilde{x}}}}{X} \wb Q \subst{\abs{\tilde{x}}{\map{U}^{\tilde{x}}}}{X} \textrm{ for some } U \\
		&&}
	\end{eqnarray*}
	$S$ is a bisimulation.
\end{corollary}
...
%		\Gamma; \es; \Delta_1 \hby{\ell} \Delta_1' \proves P_1 \Hby{\ell} P_2
