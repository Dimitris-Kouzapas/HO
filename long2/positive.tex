...
%
			\begin{enumerate}[a)]
				\item
					...
					\hby{\mapa{\ell_1}^{2}}
					\Gamma' \cdot \tmap{\Gamma}{2}; \tmap{\Delta'}{2} \proves \pmap{P'}{2} \Par R$, 
					where either \\
				...
				\item	 
					...
					{\hby{\mapa{\ell_1}^{2}}}
					{\tmap{\Delta'}{2}}{\pmap{P_0}{2}\subst{m}{x}}$.
					%where $\Gamma' = \tmap{\Gamma}{2}\subst{m}{x}$.
				...
				\item	 
					...
					$\horel{\tmap{\Gamma}{2}}{\tmap{\Delta}{2}}{\pmap{P}{2}}
					{\hby{\tau}}
					{\tmap{\Delta'}{2}}{\newsp{\tilde{m}}{\map{P_1}^{2} \Par \newsp{n}{\map{P_2}^{2}\subst{n}{x} \Par R}}}$,
					\\
					where either
				...
				\item
					If $\ell_1 = \btau$ then
					$\horel{\tmap{\Gamma}{2}}{\tmap{\Delta}{2}}{\pmap{P}{2}}{\hby{\tau} \hby{\stau}}{\tmap{\Delta'}{2}}{\pmap{P'}{2}}$
...
%			   $\map{P}^{3} \hby{ \bactinp{k}{a} \map{P'}^{3}\subst{a}{x}$.				
		...
		\item	 
			...
			\hby{\tau}
			\mapt{\Gamma}^{2};\, \mapt{\Delta'}^{2} \proves  \news{\tilde{m}}(\map{P_1}^{2} \Par \news{s}
			(\map{P_2}^{2}\subst{s}{x} \Par \binp{s}{y} \binp{y}{x} \pmap{Q}{2}))$
