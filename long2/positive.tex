...
\begin{proof}
	By induction on the inference $\Gamma; \emptyset; \Delta \proves P \hastype \Proc$.
	Details in \secref{app:enc_HOp_to_HO} (Page~\pageref{app:enc_HOp_to_HO}).
	\qed
\end{proof}
...
Intuitively, the strategy represents the exchange of a process with the exchange of a freshly generated \emph{trigger name}. 
