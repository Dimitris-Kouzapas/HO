...
\begin{proof}
	...
	Follows directly from \propref{def:enc:HOp_to_FO}, using the substitution lemma (\lemref{lem:subst})
	and \propref{prop:typepres_HOp_to_FO}.
	\qed
\end{proof}
\else
...
\iftodo\dk{	Details of the proof can be found in~\propref{app:prop:fulla_HOp_to_p}
