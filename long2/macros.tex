...
\newcommand{\wb}{\approx^{H}}
\newcommand{\swb}{\approx^{s}}
\newcommand{\wbc}{\approx}
\newcommand{\wbf}{\approx^{C}}
\newcommand{\fwb}{\wbf}
\newcommand{\hwb}{\wb}
\newcommand{\WB}{\approx}
...
%\newcommand{\shby}[1]{\stackrel{#1}{\longmapsto_{\mathsf{s}}}}
%\newcommand{\SHby}[1]{\stackrel{#1}{\Longmapsto_{\mathsf{s}}}}

%\newcommand{\bhby}[1]{\stackrel{#1}{\longmapsto_{\mathsf{\beta}}}}
%\newcommand{\BHby}[1]{\stackrel{#1}{\Longmapsto_{\mathsf{\beta}}}}

%\newcommand{\dhby}[1]{\stackrel{#1}{\longmapsto_{\mathsf{d}}}}
%\newcommand{\DHby}[1]{\stackrel{#1}{\Longmapsto_{\mathsf{d}}}}
...
\newcommand{\pmapp}[3]{\ensuremath{[\!\![#1]\!\!]^{#2}_{#3}}}
...
% Auxiliary mapping
\newcommand{\auxmap}[2]{\ensuremath{\big\lfloor\!\!\big\lfloor#1\big\rfloor\!\!\big\rfloor_{#2}}}

% Map for characteristic process
...
\newcommand{\HOpp}{\ensuremath{\mathsf{HO}\pi^{\mathsf +}}\xspace}
\newcommand{\pHOpp}{\ensuremath{\mathsf{HO}\vec{\pi}^{\mathsf +}}\xspace}
\newcommand{\PHO}{\ensuremath{\mathsf{PolyHO}\pi}\xspace}
...
\newcommand{\triggerarrow}{\Leftarrow}%{\leftarrow\!\!\!\!\!\!\!\leftarrow}
%\newcommand{\htriggerarrow}{\Leftarrow}
%\newcommand{\ftriggerarrow}{\leftarrow}

%\newcommand{\trigger}[3]{#1 \triggerarrow #2:#3 }
\newcommand{\htrigger}[2]{#1 \triggerarrow #2}
\newcommand{\ftrigger}[3]{#1 \triggerarrow #2:#3}
...
%\newcommand{\fotrigger}[3]{\dk{\binp{#1}{x} (\map{#2}^{#3} \Par \map{\tinact}^{x})}}
...
%\newcommand{\horel}[6]{#1; \es; #2 #4 #5 \proves #3 #4 #6}
...
%\dmfalse
\newcommand{\dk}[1]
{\ifdm{\color{blue}{DK NOTE: #1}}\else{#1}\fi}
...
\newcommand{\shwtytra}[6]{\ensuremath{#1; #3 \proves #4 \Hby{#2}_{\mathsf{s}} #1; #5 \proves #6 }}
...
%\newcommand{\ftrigger}[3]{#1 \leftarrow #2:#3}
