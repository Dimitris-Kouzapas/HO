...
\noi {\bf Transition Semantics:} We can observe $\pmapp{\recp{X}{\bout{a}{m} \varp{X}}}{1}{f}$ as:
\[
	\begin{array}{l}
		\pmapp{\recp{X}{\bout{a}{m} \varp{X}}}{1}{f}\\
		\scong
...
\]
%
\noi {\bf Typing Semantics:} We further show that $\pmapp{\recp{X}{\bout{a}{m} \varp{X}}}{1}{f}$ is typable:
\begin{eqnarray}
	\tree{
		\begin{array}{l}
