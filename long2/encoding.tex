...
\begin{proposition}[Operational Correspondence, \HOp into \HO]\rm
	...
	\begin{enumerate}[1.]
		...
		Then we have:
			...
			then $\exists \ell_1, x, m, P'$ s.t. \\
			$\stytra{ \Gamma }{\ell_1}{ \Delta }{ P}{ \Delta' }{ P'\subst{m}{x}}$, 
			$\ell_1 = \mapa{\ell_2}^{1}$,
			and 
			$Q \Hby{} \map{P'\subst{m}{x}}^{1}_f$.	
...
\begin{enumerate}[1.]
	%%  Output 
	\item	Subcase  (a): $P =\bout{k}{k_1} P'$ and $\ell_1 = \bactout{k}{k_1}$. By assumption, $P$ is well-typed. 
		We may have:
%
		\[
			\tree{
...
%
	...
	\item	Subcase (c): $P = \binp{k}{x} Q$	and $\ell_1 = \bactinp{k}{k_1}$.
		By assumption $P$ is well-typed.
		We may have:
%
		\[
...
%			    and $\ell_2 = \mapa{\ell_1}^{3}$.
		\end{enumerate}
		\item Suppose 
		$\stytra{\mapt{\Gamma}^{2}}{\ell_2}{\mapt{\Delta}^{2}}{\map{P}^{2}}{\mapt{\Delta'}^{2}}{R}$.s
		\begin{enumerate}[a)]
		\item
