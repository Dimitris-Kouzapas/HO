...
Type preservation enables us to focus on encodings which retain the communication structures denoted by (session) types.
...
\begin{definition}[Typed Encodings: Good and Minimal]\label{def:goodenc}
We say that 
	the typed encoding 
