...
for the negative result in \S\,\ref{s:negative}. 
...
\[
	\begin{array}{lcl}
		\pmap{\bout{u}{\abs{x}{Q}} P}{} & \defeq &  \newsp{s}{\bout{u}{s} (\pmap{P}{} \Par \binp{\dual{s}}{x} \pmap{Q}{})} \\
		\pmap{\binp{u}{x} P}{} & \defeq& \binp{u}{x} \pmap{P}{}\\
		\pmap{\appl{x}{u}}{} & \defeq & \bout{x}{u} \inact
	\end{array}
\]
%
with the remaining \HOp constructs being mapped homomorphically.
Although $\pmap{\cdot}{}$ captures the correct semantics when
