...
We say that 
	...
	\begin{enumerate}[$-$]
	\item Good, if it is syntax preserving and semantic preserving, in the sense of Definitions \ref{def:sep} and  \ref{def:ep}.
	\item Basic, if is syntax preserving, type preserving, and half of full abstraction (TBD!)
	\end{enumerate}
\end{definition}
