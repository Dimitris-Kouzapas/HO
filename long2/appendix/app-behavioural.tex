...
\begin{proof}
	\noi We prove the direction $\wb \subseteq \wbf$. The
...
%
	...
	\]
%
	From the last result we can derive that for $\Gamma; \es; \Delta \proves V_1 \hastype U$:
%
	\[
		\mhorel{\Gamma}{\Delta_1'}{\newsp{\tilde{m_1}}{P' \Par \hotrigger{t}{x}{s}{V_1}}}
...
Intuitevely, we can subsequently apply linear process substitution
...
\begin{definition}[Definibility]\rm
	...
	A visible action $\ell$ is definable whenever
