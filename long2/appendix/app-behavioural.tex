...
%
	\[
		\horel{\Gamma}{\Delta}{\bout{s}{V} P_1 \Par \binp{\dual{s}}{X} P_2}{\by{\tau}}{\Delta'}{P_1 \Par P_2}
	\]
%
...
%
	\[
		\horel{\Gamma}{\Delta}{P_1 \Par P_3}{\hby{\tau}}{\Delta'}{P_2 \Par P_3}
	\]
%
	\noi From the induction hypothesis and the fact that bisimulation is a congruence
	we get that $\horel{\Gamma}{\Delta}{P}{\wb}{\Delta'}{P'}$.
