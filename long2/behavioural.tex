...
%
\begin{eqnarray*}
	\Gamma \cat m: C_1 \cat n: \chtype{\shot{C_1}}; \es; \Delta &\proves& \binp{n}{x} \appl{x}{m} \hastype \Proc
	\\
	\Gamma \cat m: C_2 \cat n: \chtype{\shot{C_2}}; \es; \Delta &\proves& \binp{n}{x} \appl{x}{m} \hastype \Proc
\end{eqnarray*}
%
