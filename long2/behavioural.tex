...
%
	...
	\begin{array}{cc}
		\begin{array}{rclcl}
			...
			\\
			\mapchar{\btout{U} S}{u} &=& \bout{u}{\omapchar{U}} \mapchar{S}{u} %& & n \textrm{ fresh}
			\\
		...
		\begin{array}{rcrclcl}
			...
			\\
			\mapchar{\shot{C}}{x} &=& \mapchar{\lhot{C}}{x} &=& \appl{x}{\omapchar{C}}
			\\
			\\
			...
			\\
			\omapchar{\shot{C}} &=& \omapchar{\lhot{C}} &=& \abs{x}{\mapchar{C}{x}}
		\end{array}
	\end{array}
	\]
\end{definition}
