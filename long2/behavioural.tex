...
The first behavioural relation we define is reduction-closed, barb-preserving congruence:
%
...
The second behavioural relation we define a bisimulation
...
For example, the simplest process that inhabits 
...
%\begin{example}
%	Consider a second example with typed processes
%	\begin{eqnarray*}
%		\Gamma; \es; \Delta &\proves& \bout{s_1}{\abs{x}{\bout{s_2}{\inact} \inact}} \inact\\
%		\Gamma; \es; \Delta &\proves& \bout{s_1}{\inact} \bout{s_2}{\inact} \inact
%	\end{eqnarray*}
%\end{example}
...
defined as:
%
\begin{definition}[Restricted Typed Transition]\rm \label{d:restlts}
	We write
%
...
%first-order bisimilarity with $\wb^{\ftriggerarrow}$.
