...
\begin{proposition}[Environment Transition Weakening]\rm
...
\begin{proof}
	The proof exploits the weakening properties
	of the shared environment $\Gamma$ on case analysis
...
\begin{definition}[Context Bisimulation]\rm
	...
	Typed relation 
	$\Re$ is a {\em context bisimulation} if whenever
	...
	\begin{enumerate}
		\item	$\forall \news{\tilde{m_1}} \bactout{n}{V_1}$ such that
			...
			\]
			implies that $\exists Q_2$, $V_2$, $\Delta'_2$ such that
			\[
...
%
		\item	$\forall \ell \not= \news{\tilde{m}} \bactout{n}{V}$
			...
			\[
				\horel{\Gamma}{\Delta_1}{Q_1}{\By{\hat{\ell}}}{\Delta_2'}{Q_2}
			\]
			and
...
%
	\begin{enumerate}
		\item	$\forall \news{\tilde{m_1}} \bactout{n}{V_1}$ such that
			...
			\]
			implies that $\exists Q_2$, $V_2$, $\Delta_2'$ such that
			\[
...
%
		\item	$\forall \ell \not= \news{\tilde{m}} \bactout{n}{V}$ such that
			...
			\]
			implies that $\exists Q_2$, $\Delta_2'$ such that 
			\[
...
\begin{definition}[Characteristic Bisimulation]\rm
	...
	\begin{enumerate}
		\item	$\forall \news{\tilde{m_1}} \bactout{n}{V_1: U}$ such that %with \dk{$\Gamma; \es; \Delta \proves V_1 \hastype U$} such that
			...
			\]
			implies that $\exists Q_2$, $V_2$, $\Delta_2'$ such that %with \dk{$\Gamma; \es; \Delta \proves V_2 \hastype U$} such that
			\[
