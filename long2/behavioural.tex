...
%
\begin{eqnarray*}
	\Gamma \cat m: C_1; \es; \Delta \cat n: \btinp{\shot{C_1}} \tinact &\proves& \binp{n}{x} \appl{x}{m} \hastype \Proc
	\\
	\Gamma \cat m: C_2; \es; \Delta \cat n: \btinp{\shot{C_2}} \tinact &\proves& \binp{n}{x} \appl{x}{m} \hastype \Proc
\end{eqnarray*}
%
\noi can both observe the trigger input 
