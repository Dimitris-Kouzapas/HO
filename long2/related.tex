...
Due to the close relationship between higher-order process calculi and (variants of) the $\lambda$-calculus, 
works devoted to encoding the $\lambda$-calculus into (variants of) the $\pi$-calculus (see, e.g.,~\cite{San92,DBLP:journals/tcs/Fu99,DBLP:journals/iandc/YoshidaBH04,BHY}) are also worth mentioning.
...
The works~\cite{DBLP:conf/icalp/LanesePSS10,DBLP:conf/wsfm/XuYL13} focus on untyped communication;
