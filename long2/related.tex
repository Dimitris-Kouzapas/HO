...
Due to the close relationship between higher-order process calculi and the $\lambda$-calculus, 
works devoted to encoding the $\lambda$-calculus into (variants of) the $\pi$-calculus (see, e.g.,~\cite{San92,DBLP:journals/tcs/Fu99}) are also worth mentioning.
