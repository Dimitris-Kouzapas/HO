...
have been proposed; two proposals are~\cite{DBLP:journals/iandc/Gorla10,DBLP:journals/tcs/FuL10}. 
These frameworks unify criteria underlying relative expressiveness and
are applicable to different calculi.
They have shown useful to clarify known results and to derive new ones.
Our formulation of typed encoding builds upon  existing proposals (in particular~\cite{DBLP:journals/iandc/Gorla10})
