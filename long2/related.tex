...
%
\begin{enumerate}[i)]
	\item	the output of a higher-order higher-order value $\abs{x}{Q}$ on name
		...
		%
		\[
			\Gamma; \es; \Delta' \proves P \hby{\bactout{n}{\abs{x}{Q}}} \Delta_2 \proves P' \Par \htrigger{t}{\abs{x}{Q}} \hby{\bactinp{t}{\abs{x}{\mapchar{U}{x}}}} \Delta_3 \proves
	...
	\item	the input of a higher-order in the Jeffrey\&Rathke approach requires 
		...
		%
		\[
			\horel{\Gamma}{\Delta_1}{P}{\bactinp{n}{\abs{z}\binp{t}{x} \appl{x}{z}}}{\Delta_2}{P \subst{\abs{z}\binp{t}{x} \appl{x}{z}}{x}} 
		\]
		%
...
the calulus presented in~\ref{tlca07} can be exrpessed in terms of a the
