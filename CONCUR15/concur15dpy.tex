...
None of \cite{KYHH2015,KY2015,DBLP:journals/iandc/PerezCPT14}  consider session processes with higher-order communication. 
%\NY{Our work follows 
%the
...
of higher-order sessions; see~\cite{KouzapasPY15} for further applications.
