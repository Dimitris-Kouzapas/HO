...
\affil[3]{University of Groningen}
...
\Copyright{Dimitrios Kouzapas and Jorge A. P\'{e}rez and Nobuko Yoshida}%mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\paragraph*{Acknowledgment} The work has been partially sponsored by the
