	...
	\begin{frame}{Motivation}
		\begin{itemize}
			\item	Higher-order session calculi
				...
				\begin{itemize}
					\item	A {\em hybrid} computation model
...
%			\item	Equivalence theory for session typed programs
			...
			\item	Equivalence theory for higher-order sessions

			\item	We exploit session types to offer a
				\begin{itemize}
					\item	Natural (session types)
					\item	Economical (exploit linearity)
					\item	Original (wrt to bibliography)
				\end{itemize}
				solution to the problem of equivalence of session type programs.
		\end{itemize}
	\end{frame}
