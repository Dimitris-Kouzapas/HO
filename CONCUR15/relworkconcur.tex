...
crucial to prove completeness of bisimilarity, our \HOp lacks name matching.
%Contrarily 
%\jpc{In contrast,} 
...
\noi We further contrast our approach with that in~\cite{JeffreyR05} via an example:
