...
justify non-trivial protocol optimisations involving both name- and process-passing.
...
We then propose \emph{characteristic bisimilarity}: this is 
...
Besides confirming that characteristic bisimilarity is an useful reasoning technique,
...
with recursive types (cf.~\cite{JeffreyR05}).
...
%\item 
Next, %\secref{sec:overview} overviews 
we overview the
