...
Clarifying their status is key to, e.g., 
...
labelled characterisation of reduction-closed, barbed congruence 
...
for higher-order processes; however, the  calculi considered in~\cite{SangiorgiD:expmpa,San96H} do not include \emph{recursive types}, which in our experience are essential to the practice of 
session-based concurrency. A characterisation of 
%context bisimilarity 
that accounts for recursive types was given by Jeffrey and Rathke in~\cite{JeffreyR05}.
