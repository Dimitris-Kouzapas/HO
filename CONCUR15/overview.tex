...
\smallskip 
We now explain how our approach exploits session types to 
...
to denote an output transition along $n$, 
sending value $V$, and extruding names in $\widetilde{m}$. 
...
Our refined LTS admits only names, trigger values, and characteristic values in inputs.
