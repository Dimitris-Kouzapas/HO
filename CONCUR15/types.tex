...
\noi The type soundness result for \HOp (Thm.~\ref{t:sr})
...
\noi We rely on a typing system is very similar to the one detailed in~\cite{tlca07,MostrousY15}. 
Thus, we fully describe it  in \appref{app:types}. 
