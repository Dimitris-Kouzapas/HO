...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Characteristic Bisimulations for Session Processes}
...
\author[1]{Dimitrios Kouzapas}
\author[2]{Jorge A. P\'{e}rez}
\author[3]{Nobuko Yoshida}
\affil[1]{Imperial College, London}
\affil[2,3]{University of Groningen}
