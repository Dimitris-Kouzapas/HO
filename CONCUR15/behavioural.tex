...
%\myparagraph{Labels.}
%\noi 
We first define an (early) labelled transition system (LTS) on
untyped processes. 
Later on, using the \emph{environmental} transition semantics (\S\,\ref{ss:elts}), 
...
\noi The first bisimulation that we define 
