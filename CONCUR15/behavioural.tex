...
But if processes in \eqref{equ:7} and \eqref{equ:8}
...
We use an auxiliary equivalence called \emph{higher-order bisimilarity},  $\hwb$, which 
is defined as $\fwb$ but by
<<<<<<< HEAD
using  trigger processes with higher-order communication (cf.~\eqref{equ:0}).
=======
using  trigger processes with higher-order communication (cf. \eqref{equ:2}).
>>>>>>> 95a74453e246dd0ae6181fefc736ef5b507123da
