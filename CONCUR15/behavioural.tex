...
\[
	\begin{array}{rclcrcl}
		...
		\\
		\\
		\omapchar{S} & \defeq & s \quad (s \textrm{ fresh})
		&&
		\omapchar{\chtype{S}} \defeq \omapchar{\chtype{L}} &\defeq& a \quad (a \textrm{ fresh})
		\\
