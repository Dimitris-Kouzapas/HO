...
%
\begin{eqnarray}
	\Gamma; \es; \Delta \proves \newsp{s}{\binp{n}{x} (\appl{x}{s}) \Par \bout{\dual{s}}{\abs{x} R_1} \inact} \hastype \Proc
\ \mbox{and}\ 
	\Gamma; \es; \Delta \proves \newsp{s}{\binp{n}{x} (\appl{x}{s}) \Par \bout{\dual{s}}{\abs{x} R_2} \inact} \hastype \Proc\label{equ:7}\label{equ:8}
\end{eqnarray}
%
