...
ADD SMALL EXAMPLE, ALSO TO ILLUSTRATE SESSION TYPES (LINEARITY, DETERMINACY)
...
\item the session \sessp-calculus \jpc{(denoted~\sessp)}, which is \HOp without abstractions and applications.  
\end{enumerate}
While \sessp is, 
