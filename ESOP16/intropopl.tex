...
\noi 
This paper is about expressivity relations for concurrent calculi combining
both name- and process-passing, governed by a rich type discipline for structured, reciprocal communications.
Besides their foundational significance, such expressivity relations are relevant for transferring
reasoning techniques across typed calculi for concurrency.
