...
Our expressiveness results %of relative expressiveness 
enable us to identify 
a \emph{core} calculus of higher-order concurrency with session primitives.
...
In the following, we discuss further our aims, approach, and the technical challenges involved.
