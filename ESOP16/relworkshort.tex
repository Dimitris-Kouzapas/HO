...
% is shown to strictly add expressive power with respect to passing of processes only.
 ...
 Xu et al~\cite{DBLP:conf/wsfm/XuYL13} 
...
\jparagraph{Session Typed Processes.}
...
%\dk{None of the above works proposes tractable  bisimulations for higher-order processes.}  
