...
without relabeling; names are encoded using polyadic name abstractions. 
In sharp contrast with our developments (cf. \propref{prop:fulla_HOp_to_HO}), 
the encoding in~\cite{DBLP:journals/corr/XuYL15} does not satisfy full abstraction.
Indeed, only 
divergence-reflection
and 
operational correspondence (soundness and completeness) properties 
are established (however, the authors of~\cite{DBLP:journals/corr/XuYL15} described the obtained soundness statement as ``weak'').
