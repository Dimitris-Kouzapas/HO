...
offer a natural bridge between concurrent and functional computation, 
...
Also, 
recursion/replication operators are redundant in higher-order calculi, as they can be represented using process passing and duplication~\cite{ThomsenB:plachoasgcfhop}. 
