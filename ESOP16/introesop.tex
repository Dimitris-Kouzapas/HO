...
this encoding far from trivial: it crucially exploits  advances on session type duality and 
...
naturally bridge concurrent and functional computation, 
...
for %higher-order 
session concurrency.
There are good reasons for choosing these subcalculi: % for our study: 
it is known
that
%considered independently,
 first- and higher-order com\-mu\-ni\-cation %---the paradigms that uniformly coexist in \HOp---
