...
\secref{sec:overview} overviews key ideas of our first encodability result.
%\item 
...
In \secref{sec:bt} describes behavioral equalities for \HOp:
...
%\item 
\secref{sec:relwork} collects concluding remarks and reviews with related works.
