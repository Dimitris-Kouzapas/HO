...
\noindent In this section we introduce 
the \emph{higher-order session $\pi$-calculus} (\HOp).
We define its sub-calculus (\sessp and \HO) and extensions of it (\HOpp and \PHOp). 
We also introduce operational semantics, type system, and 
...
The \emph{operational semantics} of \HOp is defined in terms of a reduction relation, given
