...
\author{
	Dimitrios Kouzapas$^1$%}{University of Glasgow}{dimitrios.kouzapas@gla.ac.uk}
	\and
	Jorge A. P\'{e}rez$^2$
...
%	{}
\institute{$^1$University of Glasgow \quad$^2$University of Groningen \quad $^3 $Imperial College London  }
\maketitle
