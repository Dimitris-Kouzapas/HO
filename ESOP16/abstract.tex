...
these languages combine constructs from the $\lambda$-calculus and 
the $\pi$-calculus for the specification of communications with mobile code.
We consider 
\HOp, 
the higher-order $\pi$-calculus in
which communications are governed by \emph{session types} that express reciprocal interaction protocols.
This work develops a complete 
...
\HO can encode 
\jpc{\HOp extended with higher-order applications and abstractions}.
We also show  
...
typed equivalences for higher-order processes, as developed in our recent previous work.
