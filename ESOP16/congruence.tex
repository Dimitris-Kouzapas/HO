...
In the sequel, we write 
 $\horel{\Gamma}{\Delta}{P}{\hby{\tau}}{\Delta'}{P'}$ to denote an internal transition in the 
 typed LTS.
The auxiliary definition below allows us to distinguish two kinds of (typed) internal transitions:
