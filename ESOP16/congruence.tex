...
We   state  an up-to technique for typed processes, based on determinacy properties; it will be useful to prove our expressiveness results (\secref{sec:positive}).
