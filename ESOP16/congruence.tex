...
%
				\[
					\begin{array}{lrlll}
						\Gamma; \Delta''_1  \proves  {\newsp{\tilde{m_1}}{P_2 \Par \ftrigger{t}{V_1}}}
						\ \Re \
						\Delta''_2 \proves {\newsp{\tilde{m_2}}{Q_2 \Par \ftrigger{t}{V_2}}}
					\end{array}
				\]
...
\begin{definition}[Higher-Order Bisimilarity]%\rm
	...
	\begin{array}{lrlll}
		...
		\htrigger{t}{V_1}{U_1}}}
		\ \!\!\Re\!\!\ \Delta''_2
		\proves {\newsp{\tilde{m_2}}{Q_2 \Par \htrigger{t}{V_2}{U_2}}}
	\end{array}
	$
\end{definition}
...
%	Consider tyoed processes:
%	\begin{eqnarray*}
%		\Gamma; \es; \Delta, s': \tinact \proves P &=& \binp{n}{z_1} \newsp{s}{\binp{s}{x} \appl{(\abs{y}{\bout{n}{y} \inact})}{s_1} \Par \bout{\dual{s}}{s'} \inact} \hastype \Proc
%		\\
...
%		\text{and}&
%		\\
%		\Delta', s: \tinact \proves \newsp{s}{\binp{s}{x} \appl{(\abs{y}{\bout{n}{y} \inact})}{s_1} \Par \bout{\dual{s}}{s'} \inact} \Hby{\dtau}&,& \Delta' \proves \binp{n}{z_2} \inact \in \Re
%	\end{eqnarray*}
%\end{example}
