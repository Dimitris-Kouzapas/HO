...
for \emph{visible actions}. We shall write $\ell_1, \ell_2, \ldots$ to denote visible 
actions (different from $\tau$). Also, we shall consider LTS 
with both visible and observable actions, denoted $\hby{}_1$ and $\hby{}_2$.
As actions from different calculi are different, we also consider a mapping 
...
\label{def:lopco}
       Consider typed calculi $\tyl{L}_1$ and  $\tyl{L}_2$, defined as 
        $\tyl{L}_1=\calc{\CAL_1}{{\cal{T}}_1}{\hby{\dk{\ell_1}}_1}{\wb_1}{\proves_1}$
       and $\tyl{L}_2=\calc{\CAL_2}{{\cal{T}}_2}{\hby{\dk{\ell_2}}_2}{\wb_2}{\proves_2}$.
...
\begin{proposition}\label{p:tight}
